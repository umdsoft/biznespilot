...
<body>
    <div class="container">
        ...
        <div class="amount-highlight">
            <div class="amount">{{ number_format($transaction->amount, 0, ',', ' ') }}</div>
        ...
        <div class="details">
            ...
            <div class="details-row">
                ...
                <span class="details-value">
                    <span class="provider-badge {{ $transaction->provider === 'payme' ? 'provider-payme' : 'provider-click' }}">
            ...
            <div class="details-row">
                ...
                <span class="details-value">{{ $transaction->provider_transaction_id ?? 'N/A' }}</span>
            </div>
            <div class="details-row">
                <span class="details-label">Vaqt:</span>
                <span class="details-value">{{ now()->format('d.m.Y H:i:s') }}</span>
            </div>
        </div>
        ...
        <div class="details">
            <div class="details-row">
                ...
                <span class="details-value">{{ $business->owner->name ?? 'N/A' }}</span>
            </div>
            <div class="details-row">
                <span class="details-label">Email:</span>
                <span class="details-value">{{ $business->owner->email ?? 'N/A' }}</span>
            </div>
            <div class="details-row">
                <span class="details-label">Telefon:</span>
                <span class="details-value">{{ $business->owner->phone ?? 'N/A' }}</span>
            </div>
        </div>
        @endif

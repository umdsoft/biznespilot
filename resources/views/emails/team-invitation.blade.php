...
<body>
    <div class="container">
        ...
        <p>
            <span class="highlight">{{ $inviter->name }}</span> sizni
            <span class="highlight">{{ $business->name }}</span> biznes jamoasiga taklif qildi.
        </p>
        ...
        <div class="info-box">
            ...
            <div class="info-row">
                ...
                <span class="info-value">{{ $member->department_label }}</span>
            </div>
            <div class="info-row">
                <span class="info-label">Rol:</span>
                <span class="info-value">{{ $member->role_label }}</span>
            </div>
        </div>

        <p style="text-align: center;">
            <a href="{{ $acceptUrl }}" class="button">Taklifni qabul qilish</a>
        </p>

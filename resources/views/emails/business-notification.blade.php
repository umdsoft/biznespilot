        ...
        <div class="card">
            ...
            <div class="content">
                <span class="type-badge type-{{ $type }}">
                    @switch($type)
                        @case('alert') Ogohlantirish @break
                        @case('kpi') KPI @break
                        @case('task') Vazifa @break
                        @case('lead') Lid @break
                        @case('report') Hisobot @break
                        @case('celebration') Tabriklash @break
            ...
            <div class="footer">
                <p>
                    Bu xabar {{ $business->name }} biznesidan yuborildi.<br>
                    <a href="{{ config('app.url') }}/settings/notifications">Bildirishnoma sozlamalari</a>
                </p>
            </div>
        </div>
    </div>

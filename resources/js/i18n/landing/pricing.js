export default {
    'uz-latn': {
        ...
        // ==================== FEATURE LABELS (for plan card generation) ====================
        feature_labels: {
            users: 'xodim',
            branches: 'filial',
            instagram_accounts: 'Instagram akkaunt',
            monthly_leads: 'lid/oy',
            ai_call_minutes: 'Call Center AI',
            chatbot_channels: 'chatbot kanal',
            telegram_bots: 'Telegram bot',
            ai_requests: 'AI so\'rov',
            instagram_telegram: 'Instagram + Telegram bot',
            flow_builder: 'Flow Builder (Vizual)',
            hr_bot_marketing: 'HR Bot + Marketing ROI',
            ai_bot_antifraud: 'AI Bot + Anti-Fraud SMS',
            basic_crm: 'Asosiy CRM',
            hr_tasks: 'HR vazifalar',
            personal_manager: 'Shaxsiy menejer',
            response_time: 'soat ichida javob',
        },

        // ==================== COMPARISON STRIP ====================
        comparison_strip: {
            template: '{plan}: {users} xodim',
            business_extra: '+ HR Bot',
            premium_extra: '+ Anti-Fraud',
        },
    ...
    ru: {
        ...
        feature_labels: {
            users: 'сотрудников',
            branches: 'филиалов',
            instagram_accounts: 'аккаунтов Instagram',
            monthly_leads: 'лидов/мес',
            ai_call_minutes: 'Call Center AI',
            chatbot_channels: 'каналов чат-бота',
            telegram_bots: 'Telegram ботов',
            ai_requests: 'AI-запросов',
            instagram_telegram: 'Instagram + Telegram бот',
            flow_builder: 'Flow Builder (Визуальный)',
            hr_bot_marketing: 'HR Бот + Marketing ROI',
            ai_bot_antifraud: 'AI Бот + Anti-Fraud SMS',
            basic_crm: 'Базовая CRM',
            hr_tasks: 'HR задачи',
            personal_manager: 'Персональный менеджер',
            response_time: 'часов — время ответа',
        },

        // ==================== COMPARISON STRIP ====================
        comparison_strip: {
            template: '{plan}: {users} сотрудников',
            business_extra: '+ HR Бот',
            premium_extra: '+ Anti-Fraud',
        },

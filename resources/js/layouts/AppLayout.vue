  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    >
      ...
      <nav class="p-4 space-y-1">
        ...
        <NavLink href="/business/marketing/campaigns" :active="$page.url.startsWith('/marketing/campaigns')">
          <svg class="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <NavLink href="/target-analysis" :active="$page.url.startsWith('/target-analysis')">
        ...
        <NavLink href="/chatbot" :active="$page.url.startsWith('/chatbot')">
          <svg class="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div v-if="isAdmin" class="pt-4 mt-4 border-t border-gray-200 dark:border-gray-700">
          <NavLink href="/admin" :active="$page.url.startsWith('/admin')">
            ...
            <span class="font-semibold text-red-600">Admin Panel</span>
          </NavLink>
        </div>
      </nav>
    </aside>

...
<template>
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-3">
            ...
            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-3 text-center">
                <p class="text-xs text-gray-500 dark:text-gray-400 mb-1">CPC</p>
                ...
                >
                    <div class="flex items-center justify-between mb-3">
                        <div class="flex items-center gap-3">
                            ...
                            >
                                {{ campaign.status === 'ENABLED' ? 'Faol' : campaign.status === 'PAUSED' ? 'Pauza' : "O'chirilgan" }}
                            </span>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <button
                                ...
                                :title="campaign.status === 'ENABLED' ? 'To\'xtatish' : 'Faollashtirish'"
                            >
                    ...
                    <div class="grid grid-cols-3 sm:grid-cols-6 gap-4">
                        ...
                        <div>
                            <p class="text-xs text-gray-500 dark:text-gray-400">Kliklar</p>
                        ...
                        <div>
                            <p class="text-xs text-gray-500 dark:text-gray-400">Xarajat</p>
                        ...
                        <div>
                            <p class="text-xs text-gray-500 dark:text-gray-400">Byudjet</p>
                            <p class="text-sm font-semibold text-gray-900 dark:text-white">{{ formatCurrency(campaign.daily_budget) }}/kun</p>
                        </div>
                    </div>
                </div>
            </template>

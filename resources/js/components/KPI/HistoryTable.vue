<template>
  <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
    ...
    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
      <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Kunlik Ma'lumotlar Tarixi</h3>
    ...
    <div class="overflow-x-auto">
      <table class="w-full">
        <thead class="bg-gray-50 dark:bg-gray-700">
          <tr>
            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Sana</th>
            <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider" colspan="4">Lidlar</th>
            <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider" colspan="2">Xarajat</th>
            <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider" colspan="2">Sotuvlar</th>
            <th class="px-4 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Daromad</th>
            <th class="px-4 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Konv.</th>
            <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Amallar</th>
          </tr>
          <tr class="bg-gray-100 dark:bg-gray-600">
            ...
            <th class="px-4 py-2 text-xs text-gray-500 dark:text-gray-400">Dig</th>
            <th class="px-4 py-2 text-xs text-gray-500 dark:text-gray-400">Off</th>
            <th class="px-4 py-2 text-xs text-gray-500 dark:text-gray-400">Yangi</th>
            <th class="px-4 py-2 text-xs text-gray-500 dark:text-gray-400">Tak.</th>
            <th class="px-4 py-2"></th>
            <th class="px-4 py-2"></th>
            <th class="px-4 py-2"></th>
          </tr>
        ...
        <tfoot v-if="entries.length > 0" class="bg-gray-100 dark:bg-gray-700">
          <tr class="font-semibold">
            <td class="px-4 py-3 text-gray-900 dark:text-gray-100">Jami</td>

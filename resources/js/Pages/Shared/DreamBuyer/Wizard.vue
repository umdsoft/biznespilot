...
const goBack = () => {
    if (props.isEdit && props.dreamBuyer) {
        router.get(route(`${props.panelType}.dream-buyer.show`, props.dreamBuyer.id));
    } else {
        router.get(route(`${props.panelType}.dream-buyer.index`));
    }
};
...
const submit = () => {
    ...
    if (props.isEdit && props.dreamBuyer) {
        form.put(route(`${prefix}.dream-buyer.update`, props.dreamBuyer.id));
    } else {

...
<template>
    <component :is="layoutComponent" title="Kontent Analitikasi">
        <Head title="Kontent Analitikasi" />

        <div class="space-y-6">
            <!-- Header -->
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-bold text-gray-900">Kontent Analitikasi</h1>
            ...
            <div class="bg-white rounded-lg shadow">
                <div class="p-6 border-b">
                    <h2 class="text-lg font-semibold text-gray-900">Eng yaxshi kontentlar</h2>
                </div>
                <div class="divide-y">
                    <div
                    ...
                    >
                        ...
                        <div class="flex items-center gap-4 text-sm">
                            <span class="text-gray-500">{{ formatNumber(post.views) }} ko'rish</span>
                            <span class="text-red-500">{{ formatNumber(post.likes) }} yoqtirish</span>
                            <span class="text-blue-500">{{ formatNumber(post.comments) }} izoh</span>
                        </div>
                    </div>

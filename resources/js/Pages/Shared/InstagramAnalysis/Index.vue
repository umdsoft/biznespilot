...
// Dynamic tabs with panel-aware chatbot link
const tabs = computed(() => [
    { id: 'insights', label: 'Tavsiyalar', icon: 'lightbulb' },
    { id: 'overview', label: 'Umumiy', icon: 'chart' },
    { id: 'chatbot', label: 'Chatbot', icon: 'chat', isLink: true, href: '/integrations/instagram/chatbot' },
...
const loadOverview = async () => {
    const response = await axios.get('/integrations/instagram/api/overview', {
...
const loadMediaPerformance = async () => {
    const response = await axios.get('/integrations/instagram/api/media-performance', {
        params: { business_id: props.business.id, period: dateRange.value }
    });
...
const loadReelsAnalytics = async () => {
    const response = await axios.get('/integrations/instagram/api/reels-analytics', {
        params: { business_id: props.business.id, period: dateRange.value }
    });
...
const loadEngagement = async () => {
    const response = await axios.get('/integrations/instagram/api/engagement', {
        params: { business_id: props.business.id, period: dateRange.value }
    });
...
const loadAudience = async () => {
    const response = await axios.get('/integrations/instagram/api/audience', {
...
const loadHashtags = async () => {
    const response = await axios.get('/integrations/instagram/api/hashtags', {
...
const loadGrowthTrend = async () => {
    const response = await axios.get('/integrations/instagram/api/growth-trend', {
...
const loadContentComparison = async () => {
    const response = await axios.get('/integrations/instagram/api/content-comparison', {
        params: { business_id: props.business.id, period: dateRange.value }
    });
...
const loadBusinessInsights = async () => {
    ...
    try {
        const [insightsRes, winnersRes, growthRes, viralRes] = await Promise.all([
            axios.get('/integrations/instagram/api/business-insights', {
                params: { business_id: props.business.id }
            }),
            axios.get('/integrations/instagram/api/content-winners', {
                params: { business_id: props.business.id }
            }),
            axios.get('/integrations/instagram/api/growth-drivers', {
                params: { business_id: props.business.id }
            }),
            axios.get('/integrations/instagram/api/viral-analysis', {
                params: { business_id: props.business.id }
            }),
        ]);
...
const generateAIInsights = async () => {
    ...
    try {
        const response = await axios.post('/integrations/instagram/api/ai-insights', {
...
const syncData = async () => {
    ...
    try {
        const response = await axios.post('/integrations/instagram/sync', {
            business_id: props.business.id,
        });
...
const selectAccount = async (accountId) => {
    loading.value = true;
    try {
        await axios.post('/integrations/instagram/select-account', {
            business_id: props.business.id,

...
<template>
    <FinanceLayout :title="t('finance.expenses')">
        <Head :title="t('finance.expense_report')" />
        ...
        <div class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{{ t('finance.expense_report') }}</h1>
                        <p class="mt-1 text-gray-500 dark:text-gray-400">{{ t('finance.expense_report_desc') }}</p>
                    </div>
                </div>
                <button
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-700">
                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ t('finance.monthly_average') }}</p>
                    <p class="text-2xl font-bold text-gray-900 dark:text-white mt-1">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-700">
                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ t('finance.highest_category') }}</p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ t('finance.by_category') }}</h3>
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ t('finance.monthly_comparison') }}</h3>
                </div>
                <div class="p-6">

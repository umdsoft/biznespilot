...
<template>
    <FinanceLayout :title="t('finance.profit_loss')">
        <Head :title="t('finance.profit_loss_report')" />
        ...
        <div class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{{ t('finance.profit_loss_report') }}</h1>
                        <p class="mt-1 text-gray-500 dark:text-gray-400">{{ t('finance.profit_loss_desc') }}</p>
                    </div>
                </div>
                <button
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div class="bg-white dark:bg-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-700">
                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ t('finance.total_revenue') }}</p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-700">
                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ t('finance.total_expenses') }}</p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-700">
                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ t('finance.net_profit') }}</p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-700">
                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ t('finance.profit_margin') }}</p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ t('finance.revenue') }}</h3>
                    </div>
                    <div class="p-6">
                        <div class="space-y-4">
                            <div
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ t('finance.expenses') }}</h3>
                    </div>
                    <div class="p-6">
                        <div class="space-y-4">
                            <div
            ...
            <div class="bg-gradient-to-r from-green-500 to-emerald-600 rounded-xl p-6 text-white">
                <div class="flex items-center justify-between flex-wrap gap-4">
                    <div>
                        <h3 class="text-lg font-semibold mb-1">{{ t('finance.net_profit') }}</h3>
                        <p class="text-3xl font-bold">{{ formatFullCurrency(netProfit) }}</p>
                        <p class="text-green-100 text-sm mt-2">{{ t('finance.growth_vs_last_month') }}</p>
                    </div>
                    <div class="text-right">
                        <p class="text-green-100 text-sm">{{ t('finance.profit_margin') }}</p>

            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-500 dark:text-gray-400">
                        Ideal mijozingizni chuqur tushunish uchun har bir savolga batafsil javob bering
                    </p>
                </div>
                    ...
                    <div class="flex items-center justify-between">
                        <template v-for="(step, index) in steps" :key="index">
                            ...
                            >
                                <div
                                    :class="[
                                        'w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center text-sm font-bold transition-all duration-300',
                                        currentStep === index
                                ...
                                <!-- Step Label (visible on hover/current) -->
                                <div
                                    v-if="currentStep === index"
                                    class="absolute -bottom-6 left-1/2 -translate-x-1/2 whitespace-nowrap text-xs font-medium text-indigo-600 dark:text-indigo-400"
                                >
                                    {{ step.shortTitle }}
                                </div>
                            </button>
                            ...
                            <div
                                ...
                                class="flex-1 h-1 mx-1 sm:mx-2 rounded-full transition-all duration-500"
                    ...
                    >
                        <div :key="currentStep">
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                                <!-- Step Header -->
                                <div class="text-center py-8 px-6 border-b border-gray-100 dark:border-gray-700">
                                    <div
                                        class="w-20 h-20 mx-auto mb-4 rounded-2xl flex items-center justify-center"
                                        :class="steps[currentStep].iconBg"
                                    >
                                        <component :is="steps[currentStep].icon" class="w-10 h-10" :class="steps[currentStep].iconColor" />
                                    </div>
                                ...
                                <div class="p-6 sm:p-8">
                                    ...
                                    <div v-if="currentStep === 0" class="space-y-6">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                class="w-full px-4 py-4 rounded-xl border-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-4 focus:ring-indigo-500/10 transition-all text-lg"
                                            />
                                        ...
                                        <div>
                                            ...
                                            <textarea
                                                ...
                                                class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-4 focus:ring-indigo-500/10 transition-all resize-none"
                                            ></textarea>
                                        </div>
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-gray-100 dark:border-gray-700">
                                            <div>
                                                ...
                                                <select
                                                    ...
                                                    class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-4 focus:ring-indigo-500/10 transition-all"
                                                >
                                    ...
                                    <div v-else-if="currentStep === 1" class="space-y-4">
                                        ...
                                        <textarea
                                            ...
                                            class="w-full px-4 py-4 rounded-xl border-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:border-blue-500 dark:focus:border-blue-400 focus:ring-4 focus:ring-blue-500/10 transition-all resize-none"
                                        ></textarea>
                                    ...
                                    <div v-else-if="currentStep === 2" class="space-y-4">
                                        ...
                                        <textarea
                                            ...
                                            class="w-full px-4 py-4 rounded-xl border-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:border-cyan-500 dark:focus:border-cyan-400 focus:ring-4 focus:ring-cyan-500/10 transition-all resize-none"
                                        ></textarea>
                                    ...
                                    <div v-else-if="currentStep === 3" class="space-y-4">
                                        <textarea
                                            ...
                                            class="w-full px-4 py-4 rounded-xl border-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:border-red-500 dark:focus:border-red-400 focus:ring-4 focus:ring-red-500/10 transition-all resize-none"
                                        ></textarea>
                                    ...
                                    <div v-else-if="currentStep === 4" class="space-y-4">
                                        <textarea
                                            ...
                                            class="w-full px-4 py-4 rounded-xl border-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:border-green-500 dark:focus:border-green-400 focus:ring-4 focus:ring-green-500/10 transition-all resize-none"
                                        ></textarea>
                                    ...
                                    <div v-else-if="currentStep === 5" class="space-y-4">
                                        <textarea
                                            ...
                                            class="w-full px-4 py-4 rounded-xl border-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:border-orange-500 dark:focus:border-orange-400 focus:ring-4 focus:ring-orange-500/10 transition-all resize-none"
                                        ></textarea>
                                    ...
                                    <div v-else-if="currentStep === 6" class="space-y-4">
                                        ...
                                        <textarea
                                            ...
                                            class="w-full px-4 py-4 rounded-xl border-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:border-purple-500 dark:focus:border-purple-400 focus:ring-4 focus:ring-purple-500/10 transition-all resize-none"
                                        ></textarea>
                                    ...
                                    <div v-else-if="currentStep === 7" class="space-y-4">
                                        ...
                                        <textarea
                                            ...
                                            class="w-full px-4 py-4 rounded-xl border-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:border-pink-500 dark:focus:border-pink-400 focus:ring-4 focus:ring-pink-500/10 transition-all resize-none"
                                        ></textarea>
                                    </div>
                                    ...
                                    <div v-else-if="currentStep === 8" class="space-y-6">
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
                                                <label class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide">Profil Nomi</label>
                                                <p class="text-gray-900 dark:text-white font-medium mt-1">{{ form.name || '—' }}</p>
                                            </div>
                                            <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
                                                <label class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide">Prioritet</label>
                                                <p class="text-gray-900 dark:text-white font-medium mt-1 capitalize">{{ form.priority }}</p>
                                            </div>
                                        </div>

                                        <div class="space-y-4">
                                            <SummaryItem label="Qayerda topish mumkin" :value="form.where_spend_time" color="blue" />
                                            <SummaryItem label="Ma'lumot manbalari" :value="form.info_sources" color="cyan" />
                                            <SummaryItem label="Frustratsiyalar" :value="form.frustrations" color="red" />
                                            <SummaryItem label="Orzular va maqsadlar" :value="form.dreams" color="green" />
                                            <SummaryItem label="Qo'rquvlar" :value="form.fears" color="orange" />
                                            <SummaryItem label="Kommunikatsiya" :value="form.communication_preferences" color="purple" />
                                            <SummaryItem v-if="form.language_style" label="Til uslubi" :value="form.language_style" color="pink" />
                                        </div>
                                    </div>

                                    <!-- Tip Box -->
                                    <div v-if="steps[currentStep].tip" class="mt-6 p-4 rounded-xl border" :class="steps[currentStep].tipClass">
                                        <div class="flex gap-3">
                                            <div class="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0" :class="steps[currentStep].tipIconBg">
                                                <svg class="w-4 h-4" :class="steps[currentStep].tipIconColor" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                                                </svg>
                                            </div>
                                            <div>
                                                <p class="text-sm font-semibold" :class="steps[currentStep].tipTitleColor">Maslahat</p>
                                                <p class="text-sm mt-0.5" :class="steps[currentStep].tipTextColor">{{ steps[currentStep].tip }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="mt-8 flex items-center justify-between">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <button
                                ...
                                class="inline-flex items-center gap-2 px-6 py-3 bg-indigo-600 text-white font-semibold rounded-xl hover:bg-indigo-700 shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-indigo-600"
                            >
                                Keyingi
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button
                                ...
                                class="inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-xl hover:from-indigo-700 hover:to-purple-700 shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                            >
...
const SummaryItem = {
    ...
    setup(props) {
        ...
        return () => h('div', { class: `p-4 rounded-xl border ${colorClasses[props.color] || colorClasses.blue}` }, [
            h('label', { class: 'text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide block mb-1' }, props.label),
...
const steps = [
    {
        ...
        field: 'name',
        tip: "Ikki-uch so'zdan iborat aniq nom bering. Keyinchalik AI o'zi ham nom taklif qiladi.",
        tipClass: 'bg-indigo-50 dark:bg-indigo-900/20 border-indigo-200 dark:border-indigo-800',
        tipIconBg: 'bg-indigo-100 dark:bg-indigo-900/50',
        tipIconColor: 'text-indigo-600 dark:text-indigo-400',
        tipTitleColor: 'text-indigo-800 dark:text-indigo-300',
        tipTextColor: 'text-indigo-700 dark:text-indigo-400',
    },
    {
        ...
        tipClass: 'bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800',
        tipIconBg: 'bg-blue-100 dark:bg-blue-900/50',
        tipIconColor: 'text-blue-600 dark:text-blue-400',
        tipTitleColor: 'text-blue-800 dark:text-blue-300',
        tipTextColor: 'text-blue-700 dark:text-blue-400',
    },
    {
        ...
        tipClass: 'bg-cyan-50 dark:bg-cyan-900/20 border-cyan-200 dark:border-cyan-800',
        tipIconBg: 'bg-cyan-100 dark:bg-cyan-900/50',
        tipIconColor: 'text-cyan-600 dark:text-cyan-400',
        tipTitleColor: 'text-cyan-800 dark:text-cyan-300',
        tipTextColor: 'text-cyan-700 dark:text-cyan-400',
    },
    {
        title: "Frustratsiyalari nima?",
        shortTitle: 'Muammolar',
        description: 'Eng katta qiyinchiliklari va frustratsiyalari',
        icon: FireIcon,
        iconBg: 'bg-red-100 dark:bg-red-900/30',
        iconColor: 'text-red-600 dark:text-red-400',
        field: 'frustrations',
        tip: "Bu pain pointlar sizning marketing xabarlaringizning asosi bo'ladi. Qanchalik chuqur tushunsangiz, shunchalik samarali sotasiz.",
        tipClass: 'bg-red-50 dark:bg-red-900/20 border-red-200 dark:border-red-800',
        tipIconBg: 'bg-red-100 dark:bg-red-900/50',
        tipIconColor: 'text-red-600 dark:text-red-400',
        tipTitleColor: 'text-red-800 dark:text-red-300',
        tipTextColor: 'text-red-700 dark:text-red-400',
    },
    {
        title: "Orzulari nima?",
        shortTitle: 'Orzular',
        ...
        tipClass: 'bg-green-50 dark:bg-green-900/20 border-green-200 dark:border-green-800',
        tipIconBg: 'bg-green-100 dark:bg-green-900/50',
        tipIconColor: 'text-green-600 dark:text-green-400',
        tipTitleColor: 'text-green-800 dark:text-green-300',
        tipTextColor: 'text-green-700 dark:text-green-400',
    },
    {
        ...
        field: 'fears',
        tip: "Qo'rquvlarni bilish e'tirozlarni yengishga yordam beradi. Ular nimadan cho'chiydi?",
        tipClass: 'bg-orange-50 dark:bg-orange-900/20 border-orange-200 dark:border-orange-800',
        tipIconBg: 'bg-orange-100 dark:bg-orange-900/50',
        tipIconColor: 'text-orange-600 dark:text-orange-400',
        tipTitleColor: 'text-orange-800 dark:text-orange-300',
        tipTextColor: 'text-orange-700 dark:text-orange-400',
    },
    {
        ...
        tipClass: 'bg-purple-50 dark:bg-purple-900/20 border-purple-200 dark:border-purple-800',
        tipIconBg: 'bg-purple-100 dark:bg-purple-900/50',
        tipIconColor: 'text-purple-600 dark:text-purple-400',
        tipTitleColor: 'text-purple-800 dark:text-purple-300',
        tipTextColor: 'text-purple-700 dark:text-purple-400',
    },
    {
        ...
        tipClass: 'bg-pink-50 dark:bg-pink-900/20 border-pink-200 dark:border-pink-800',
        tipIconBg: 'bg-pink-100 dark:bg-pink-900/50',
        tipIconColor: 'text-pink-600 dark:text-pink-400',
        tipTitleColor: 'text-pink-800 dark:text-pink-300',
        tipTextColor: 'text-pink-700 dark:text-pink-400',
    },
    {
        title: "Yakuniy ko'rish",
        shortTitle: 'Yakunlash',
...
const progressColor = computed(() => {
    if (progressPercent.value < 33) return 'text-red-500';
    if (progressPercent.value < 66) return 'text-yellow-500';
    return 'text-green-500';
});

const progressBarColor = computed(() => {
    if (progressPercent.value < 33) return 'bg-gradient-to-r from-red-500 to-orange-500';
    if (progressPercent.value < 66) return 'bg-gradient-to-r from-orange-500 to-yellow-500';
...
const canGoToStep = (index) => {
    ...
    // Can only go to next step if all previous steps are complete

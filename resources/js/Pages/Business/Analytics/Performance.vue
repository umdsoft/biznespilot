...
const getPerformanceBadge = (conversionRate) => {
    if (conversionRate >= 30) return { bg: 'bg-green-100', text: 'text-green-800', label: 'Excellent' };
    if (conversionRate >= 20) return { bg: 'bg-blue-100', text: 'text-blue-800', label: 'Good' };
    if (conversionRate >= 10) return { bg: 'bg-yellow-100', text: 'text-yellow-800', label: 'Average' };
    return { bg: 'bg-red-100', text: 'text-red-800', label: 'Poor' };
};

// Get ROI badge color
const getRoiBadge = (roi) => {
    if (roi >= 200) return { bg: 'bg-green-100', text: 'text-green-800', label: 'Excellent' };
    if (roi >= 100) return { bg: 'bg-blue-100', text: 'text-blue-800', label: 'Good' };
    if (roi >= 0) return { bg: 'bg-yellow-100', text: 'text-yellow-800', label: 'Break Even' };
    return { bg: 'bg-red-100', text: 'text-red-800', label: 'Loss' };
};
                ...
                <div class="bg-white rounded-xl shadow-md mb-8">
                    ...
                    <div v-show="activeTab === 'dream-buyers'" class="p-6">
                                        ...
                                        >
                                            <td class="py-4 px-4">
                                                <div class="flex items-center gap-2">
                                                    <div v-if="index === 0" class="w-6 h-6 bg-yellow-100 rounded-full flex items-center justify-center">
                                                        <TrophyIcon class="w-4 h-4 text-yellow-600" />
                                                    </div>
                                                    <span class="font-medium text-gray-900">{{ buyer.dream_buyer_name }}</span>
                                                </div>
                                            </td>
                                            <td class="py-4 px-4 text-right text-gray-700">{{ buyer.total_leads }}</td>
                                            <td class="py-4 px-4 text-right font-semibold text-green-600">{{ buyer.won_leads }}</td>
                                            <td class="py-4 px-4 text-right">
                                                <span class="font-semibold text-purple-600">{{ formatPercent(buyer.conversion_rate) }}%</span>
                                            </td>
                                            <td class="py-4 px-4 text-right font-semibold text-blue-600">
                        ...
                        <div v-else class="text-center py-12">
                            ...
                            <p class="mt-4 text-gray-500">Ma'lumot yo'q</p>
                        </div>
                    </div>
                        ...
                        <div v-if="offer_performance && offer_performance.length > 0">
                            <div class="overflow-x-auto">
                                <table class="w-full">
                                    <thead>
                                        <tr class="border-b border-gray-200">
                                            <th class="text-left py-3 px-4 font-semibold text-gray-700">Offer</th>
                                            <th class="text-center py-3 px-4 font-semibold text-gray-700">Value Score</th>
                                            <th class="text-right py-3 px-4 font-semibold text-gray-700">Total Leads</th>
                                            <th class="text-right py-3 px-4 font-semibold text-gray-700">Won Deals</th>
                                            <th class="text-right py-3 px-4 font-semibold text-gray-700">Conversion Rate</th>
                                            <th class="text-right py-3 px-4 font-semibold text-gray-700">Total Revenue</th>
                                        ...
                                        >
                                            <td class="py-4 px-4">
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <span class="font-medium text-gray-900">{{ offer.offer_name }}</span>
                                                </div>
                                            </td>
                                            <td class="py-4 px-4 text-center">
                                            ...
                                            <td class="py-4 px-4 text-right text-gray-700">{{ offer.total_leads }}</td>
                                            <td class="py-4 px-4 text-right font-semibold text-green-600">{{ offer.won_leads }}</td>
                                            <td class="py-4 px-4 text-right">
                                                <span class="font-semibold text-purple-600">{{ formatPercent(offer.conversion_rate) }}%</span>
                                            </td>
                                            <td class="py-4 px-4 text-right font-semibold text-blue-600">
                                ...
                                <table class="w-full">
                                    <thead>
                                        <tr class="border-b border-gray-200">
                                            ...
                                            <th class="text-right py-3 px-4 font-semibold text-gray-700">Conversion Rate</th>
                                            <th class="text-right py-3 px-4 font-semibold text-gray-700">Total Revenue</th>
                                            <th class="text-right py-3 px-4 font-semibold text-gray-700">Cost per Lead</th>
                                            <th class="text-right py-3 px-4 font-semibold text-gray-700">ROI</th>
                                            <th class="text-right py-3 px-4 font-semibold text-gray-700">ROAS</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr
                                        ...
                                        >
                                            ...
                                            <td class="py-4 px-4 text-right text-gray-700">{{ source.total_leads }}</td>
                                            <td class="py-4 px-4 text-right font-semibold text-green-600">{{ source.won_leads }}</td>
                                            <td class="py-4 px-4 text-right">
                                                <span class="font-semibold text-purple-600">{{ formatPercent(source.conversion_rate) }}%</span>
                                            </td>
                                            <td class="py-4 px-4 text-right font-semibold text-blue-600">
                                            ...
                                            <td class="py-4 px-4 text-right">
                                                <span class="font-semibold text-orange-600">{{ source.roas?.toFixed(2) || '0.00' }}x</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>

...
const form = useForm({
    ...
    redirect_url: '',
    show_lead_magnet_on_success: true,
    track_utm: true,
});
...
const submit = () => {
    form.post(route('business.lead-forms.store'));
};
...
const isStepValid = (step) => {
    switch (step) {
        case 1:
            return form.name && form.title && form.fields.length > 0;
        case 2:
            if (form.lead_magnet_type === 'file') return form.lead_magnet_file;
            if (form.lead_magnet_type === 'link') return form.lead_magnet_link;
            if (form.lead_magnet_type === 'coupon' || form.lead_magnet_type === 'text') return form.lead_magnet_text;
            return true;
        case 3:
            return true;
        default:
    ...
    <BusinessLayout title="Forma Yaratish">
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Lead Forma Yaratish</h1>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Lidlarni to'plash uchun yangi forma yarating</p>
                </div>
            </div>
                ...
                <div class="inline-flex items-center bg-white dark:bg-gray-800 rounded-2xl p-1.5 border border-gray-200 dark:border-gray-700 shadow-sm">
                    ...
                    >
                        <span
                            ...
                            :class="activeStep === step ? 'bg-white/20' : activeStep > step ? 'bg-emerald-100 dark:bg-emerald-900/50 text-emerald-600 dark:text-emerald-400' : 'bg-gray-100 dark:bg-gray-700'"
                        >
                            <svg v-if="activeStep > step" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="space-y-6">
                ...
                <div v-show="activeStep === 1" class="space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    v-model="form.name"
                                    type="text"
                                    placeholder="Masalan: Landing page lead form"
                        ...
                        <div class="mt-6">
                            ...
                            <textarea
                                ...
                                rows="2"
                                placeholder="Forma haqida qisqa izoh..."
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
                        ...
                        <div v-if="form.fields.length === 0" class="text-center py-12">
                            ...
                            <p class="text-gray-500 dark:text-gray-400 font-medium">Hali maydonlar qo'shilmagan</p>
                            <p class="text-gray-400 dark:text-gray-500 text-sm mt-1">Yuqoridagi tugmani bosib maydon qo'shing</p>
                        </div>
                    ...
                    <div v-if="form.lead_magnet_type !== 'none'" class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
                        ...
                        <div class="space-y-6">
                            ...
                            <div v-if="form.lead_magnet_type === 'file'">
                                ...
                                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">PDF, Word, Excel, ZIP - maksimum 10MB</p>
                            </div>
                ...
                <div class="flex items-center justify-center gap-4 mt-8 pb-4">
                    ...
                    >
                        ...
                        {{ form.processing ? 'Saqlanmoqda...' : 'Forma Yaratish' }}
                    </button>
                </div>
            </div>
        </div>

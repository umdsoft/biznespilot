...
<template>
    ...
    <BusinessLayout>
        <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
            <!-- Flash Messages -->
            <div v-if="showFlash" class="mx-auto px-4 sm:px-6 lg:px-8 pt-6">
            ...
            <div class="mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div v-if="!hasMetaAccount" class="text-center py-20">
                    <div class="max-w-lg mx-auto">
                        <div class="w-24 h-24 bg-blue-600 dark:bg-blue-700 rounded-xl flex items-center justify-center mx-auto mb-8">
                        ...
                        <button @click="connectMeta" :disabled="metaConnecting"
                            class="inline-flex items-center gap-3 px-8 py-4 bg-blue-600 dark:bg-blue-700 text-white rounded-xl hover:bg-blue-700 dark:hover:bg-blue-600 font-semibold text-lg transition-all disabled:opacity-50">
                    ...
                    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 mb-6">
                        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                            <div class="flex items-center gap-4">
                                <div class="w-14 h-14 bg-blue-600 dark:bg-blue-700 rounded-xl flex items-center justify-center">
                            ...
                            <div class="flex flex-wrap items-center gap-2">
                                ...
                                <button @click="generateAIInsights" :disabled="generatingAI || !metaDataLoaded"
                                    class="px-4 py-2.5 bg-purple-600 dark:bg-purple-700 text-white rounded-xl hover:bg-purple-700 dark:hover:bg-purple-600 transition-colors flex items-center gap-2 text-sm font-medium disabled:opacity-50">
                    ...
                    <div v-else-if="metaDataLoaded">
                        ...
                        <div v-show="activeTab === 'overview'" class="space-y-6">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                                <div class="bg-blue-600 dark:bg-blue-700 rounded-xl p-5 text-white">
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                                ...
                                <div v-if="metaPlacements.platforms?.length" class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                                    <div v-for="item in metaPlacements.platforms" :key="item.platform" class="text-center p-4 rounded-xl bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                                        <!-- Instagram -->
                                        <div v-if="item.platform === 'instagram'" class="w-14 h-14 mx-auto mb-3 rounded-xl bg-pink-600 dark:bg-pink-700 flex items-center justify-center">
                                        ...
                                        <!-- Facebook -->
                                        <div v-else-if="item.platform === 'facebook'" class="w-14 h-14 mx-auto mb-3 rounded-xl bg-blue-600 dark:bg-blue-700 flex items-center justify-center">
                                            <svg class="w-7 h-7 text-white" viewBox="0 0 24 24" fill="currentColor">
                                                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                                            </svg>
                                        </div>
                                        <!-- Messenger -->
                                        <div v-else-if="item.platform === 'messenger'" class="w-14 h-14 mx-auto mb-3 rounded-xl bg-purple-600 dark:bg-purple-700 flex items-center justify-center">
                                            <svg class="w-7 h-7 text-white" viewBox="0 0 24 24" fill="currentColor">
                                        ...
                                        <!-- Audience Network -->
                                        <div v-else-if="item.platform === 'audience_network'" class="w-14 h-14 mx-auto mb-3 rounded-xl bg-green-600 dark:bg-green-700 flex items-center justify-center">
                                        ...
                                        <!-- Threads -->
                                        <div v-else-if="item.platform === 'threads'" class="w-14 h-14 mx-auto mb-3 rounded-xl bg-gray-900 dark:bg-gray-600 flex items-center justify-center">
                                            <svg class="w-7 h-7 text-white" viewBox="0 0 24 24" fill="currentColor">
                                        ...
                                        <!-- Default -->
                                        <div v-else class="w-14 h-14 mx-auto mb-3 rounded-xl bg-gray-500 dark:bg-gray-600 flex items-center justify-center">
                                            <svg class="w-7 h-7 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                                <circle cx="12" cy="12" r="10"/>
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                                ...
                                <div v-if="metaPlacements.platforms?.length" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                    <div v-for="item in metaPlacements.platforms" :key="item.label" class="flex items-center gap-4 p-5 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                                        ...
                                        <!-- Default -->
                                        <div v-else class="w-14 h-14 rounded-xl bg-gray-400 dark:bg-gray-600 flex items-center justify-center flex-shrink-0">
                                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">

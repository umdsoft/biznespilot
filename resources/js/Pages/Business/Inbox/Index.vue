        ...
        <div class="space-y-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <button
                    ...
                    class="inline-flex items-center px-4 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white text-sm font-semibold rounded-xl transition-all shadow-lg shadow-blue-500/30 hover:shadow-xl disabled:opacity-50"
                >
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
                ...
                <!-- Response Rate -->
                <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 hover:shadow-lg hover:border-blue-300 dark:hover:border-blue-600 transition-all cursor-pointer group">
                    <div class="flex items-center justify-between">
                        <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-100 to-indigo-200 dark:from-blue-900/30 dark:to-indigo-800/30 flex items-center justify-center group-hover:scale-110 transition-transform">
                    ...
                    <div class="mt-3">
                        <p class="text-2xl font-bold text-blue-600 dark:text-blue-400">{{ statsData.response_rate?.toFixed(1) || 0 }}%</p>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="relative flex-shrink-0">
                                    <div class="w-12 h-12 rounded-full flex items-center justify-center shadow-md"
                                        ...
                                        <component :is="getChannelIcon(conversation.channel)" class="w-6 h-6" :class="getChannelIconClass(conversation.channel)" />
                                    </div>
                                    <!-- Online indicator -->
                ...
                <div class="lg:col-span-2 bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden flex flex-col shadow-sm" style="height: 700px;">
                    ...
                    <div v-if="!selectedConversationId" class="flex-1 flex flex-col items-center justify-center text-center p-8">
                        <div class="relative w-24 h-24 mb-6">
                            ...
                            <div class="relative w-24 h-24 rounded-full bg-gradient-to-br from-blue-100 to-indigo-200 dark:from-blue-900/30 dark:to-indigo-800/30 flex items-center justify-center">
                                    ...
                                    <div class="flex items-center gap-4">
                                        <div class="relative">
                                            <div class="w-14 h-14 rounded-full flex items-center justify-center shadow-lg"
                                                ...
                                                <component :is="getChannelIcon(currentConversation.channel)" class="w-7 h-7" :class="getChannelIconClass(currentConversation.channel)" />
                                            </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="flex items-center gap-2 mt-0.5">
                                                ...
                                                <span class="text-sm text-gray-500 dark:text-gray-400 capitalize flex items-center gap-1">
                                                    <component :is="getChannelIcon(currentConversation.channel)" class="w-3.5 h-3.5" :class="getChannelIconClass(currentConversation.channel)" />
                            ...
                            <div ref="messagesContainer" class="flex-1 overflow-y-auto p-6 space-y-4 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900/50 dark:to-gray-800/50">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <p class="text-xs mt-1.5" :class="message.direction === 'outbound' ? 'text-blue-200' : 'text-gray-400'">
                                            {{ message.human_time }}
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="flex-shrink-0 p-4 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                                <form @submit.prevent="sendMessage" class="flex items-center gap-3">
                                    ...
                                    <button
                                        ...
                                        class="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-xl transition-all shadow-lg shadow-blue-500/30 hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed disabled:shadow-none"
                                    >
...
const fetchConversations = async () => {
    try {
        ...
        const response = await axios.get(route('business.inbox.index') + '?' + params.toString(), {
...
const fetchCurrentMessages = async () => {
    ...
    try {
        const response = await axios.get(route('business.inbox.show', selectedConversationId.value))

<template>
    <BusinessLayout title="Yangi Kampaniya">
        <div class="py-12">
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <!-- Header -->
                <div class="mb-8">
                    <Link :href="route('business.marketing.campaigns.index')" class="text-purple-600 hover:text-purple-700 mb-4 inline-flex items-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                        </svg>
                        Orqaga
                    </Link>
                    <h2 class="text-3xl font-bold text-gray-900 mt-2">Yangi Marketing Kampaniya</h2>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-md p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div
                                ...
                                :class="form.type === 'broadcast' ? 'border-purple-500 bg-purple-50' : 'border-gray-200 hover:border-purple-300'"
                            >
                                <div class="flex items-center justify-between mb-2">
                                    <h4 class="font-semibold text-gray-900">Ommaviy</h4>
                                ...
                                <p class="text-sm text-gray-600">Bir vaqtning o'zida barchaga yuborish</p>
                            </div>

                            <div
                                @click="form.type = 'drip'"
                                class="cursor-pointer border-2 rounded-lg p-4 transition-all"
                                :class="form.type === 'drip' ? 'border-purple-500 bg-purple-50' : 'border-gray-200 hover:border-purple-300'"
                            >
                                <div class="flex items-center justify-between mb-2">
                                    <h4 class="font-semibold text-gray-900">Drip</h4>
                                ...
                                <p class="text-sm text-gray-600">Ketma-ket xabarlar seriyasi</p>
                            </div>

                            <div
                                @click="form.type = 'trigger'"
                                class="cursor-pointer border-2 rounded-lg p-4 transition-all"
                                :class="form.type === 'trigger' ? 'border-purple-500 bg-purple-50' : 'border-gray-200 hover:border-purple-300'"
                            >
                                <div class="flex items-center justify-between mb-2">
                                ...
                                <p class="text-sm text-gray-600">Harakatga asoslangan avtomatik</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-md p-6">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-5 gap-3">
                            <div
                                ...
                                :class="form.channel === channel.value ? 'border-purple-500 bg-purple-50' : 'border-gray-200 hover:border-purple-300'"
                            >
                    ...
                    <div class="bg-white rounded-xl shadow-md p-6">
                        ...
                        <div class="space-y-3">
                            <label class="flex items-center">
                                ...
                                />
                                <span class="ml-3 text-sm text-gray-900">Darhol yuborish</span>
                            </label>
                            <label class="flex items-center">
                                <input
                                    v-model="form.schedule_type"
                                    ...
                                    class="w-4 h-4 text-purple-600 focus:ring-purple-500"
                                />
                                <span class="ml-3 text-sm text-gray-900">Rejalashtirilgan vaqtda</span>
                            </label>
                        </div>
                    ...
                    <div class="flex justify-end space-x-3">
                        <Link
                            :href="route('business.marketing.campaigns.index')"
...
const generateAIMessage = async () => {
    ...
    try {
        const response = await axios.post(route('business.marketing.campaigns.generate-ai'), {
...
const submit = () => {
    ...
    form.post(route('business.marketing.campaigns.store'), {
        onFinish: () => {

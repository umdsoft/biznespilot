            ...
            <div class="border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-6 py-4">
                <div class="max-w-5xl mx-auto">
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Yangi so'rovnoma</h1>
            ...
            >
                <div v-if="showAddQuestion" class="fixed inset-0 z-50 overflow-y-auto">
                    <div class="flex items-center justify-center min-h-screen px-4 py-8">
                        ...
                        >
                            <div v-if="showAddQuestion" class="relative bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 max-w-xl w-full overflow-hidden">
                                <!-- Modal Header -->
                                <div class="px-5 py-4 border-b border-gray-200 dark:border-gray-700">
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">Yangi savol qo'shish</h3>
                                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">So'rovnomaga yangi savol qo'shing</p>
                                        </div>
                                        <button
                                ...
                                <div class="bg-gray-50 dark:bg-gray-900/70 px-6 py-4 flex gap-3 border-t border-gray-200 dark:border-gray-600">
                                    ...
                                    <button
                                        ...
                                        class="flex-1 px-4 py-3 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-medium rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                                    >
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                                        </svg>
                ...
                <div v-if="showEditQuestion" class="fixed inset-0 z-50 overflow-y-auto">
                    <div class="flex items-center justify-center min-h-screen px-4 py-8">
                        ...
                        <Transition
                            ...
                            leave-to-class="opacity-0 scale-95 translate-y-4"
                        >
                            <div v-if="showEditQuestion" class="relative bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 max-w-xl w-full overflow-hidden">
                                <!-- Modal Header -->
            ...
            >
                <div v-if="showPreview" class="fixed inset-0 z-50 overflow-y-auto">
                    <div class="flex items-center justify-center min-h-screen px-4 py-8">
                        ...
                        <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 max-w-lg w-full overflow-hidden">
                            <!-- Preview Header -->

...
// Note: This is an HR-specific version of Marketing/Custdev/Create.vue
...
const submit = () => {
    if (props.isEdit) {
        form.put(route('hr.custdev.update', { custdev: props.survey.id }), {
            onError: (errors) => {
                console.error('Form errors:', errors);
            },
        });
    } else {
        form.post(route('hr.custdev.store'), {
            onError: (errors) => {
                console.error('Form errors:', errors);
            },
        });
...
<template>
    <HRLayout :title="isEdit ? t('custdev.edit_survey') : t('custdev.new_survey')">
                ...
                <div class="max-w-5xl mx-auto">
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Nomzodlarni professional baholash so'rovnomasi</p>
                        </div>

...
const toggleStatus = () => {
    router.post(route('hr.custdev.toggle-status', { custdev: props.survey.id }), {}, {
        preserveScroll: true,
    });
};
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <Link
                        :href="route('hr.custdev.edit', { custdev: survey.id })"
                        class="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 font-medium rounded-xl transition-colors"
                    >
                    ...
                    <Link
                        :href="route('hr.custdev.results', { custdev: survey.id })"

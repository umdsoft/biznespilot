<template>
  <LandingLayout v-slot="{ urgencyBarVisible }">
    <Head title="Biz haqimizda — BiznesPilot" />
    ...
    <div class="min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div class="text-center max-w-3xl mx-auto">
            ...
            <h1 class="text-4xl sm:text-5xl font-bold text-slate-900 mb-6">
              <span class="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">BiznesPilot</span> haqida
            </h1>
      ...
      <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="text-center mb-16">
            <h2 class="text-3xl font-bold text-slate-900 mb-4">Biznes Operatsion Tizimi nima?</h2>
          ...
          <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div v-for="m in modules" :key="m.title" class="rounded-2xl p-6 border" :class="m.cardClass">
          ...
          <div class="grid md:grid-cols-2 gap-12">
            ...
            <div class="relative">
              ...
              <div class="bg-white rounded-3xl p-8 border border-slate-200 shadow-lg">
                ...
                <h2 class="text-2xl font-bold text-slate-900 mb-4">Bizning Missiyamiz</h2>
            ...
            <div class="relative">
              ...
              <div class="bg-white rounded-3xl p-8 border border-slate-200 shadow-lg">
                ...
                <h2 class="text-2xl font-bold text-slate-900 mb-4">Bizning Visionimiz</h2>
                <p class="text-slate-600 leading-relaxed">
      ...
      <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="text-center mb-16">
            <h2 class="text-3xl font-bold text-slate-900 mb-4">Nega aynan BiznesPilot?</h2>
          ...
          <div class="grid md:grid-cols-3 gap-8">
            <div v-for="feature in features" :key="feature.title" class="bg-slate-50 rounded-2xl p-8 hover:shadow-lg transition-all hover:-translate-y-1 duration-300">
      ...
      <section class="py-20 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="text-center mb-16">
            <h2 class="text-3xl font-bold text-slate-900 mb-4">Bizning qadriyatlarimiz</h2>
            <p class="text-xl text-slate-600">Biz amal qiladigan tamoyillar</p>
          </div>

          <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div v-for="value in values" :key="value.title" class="text-center p-6 rounded-2xl bg-white border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div class="grid sm:grid-cols-3 gap-6 mb-10">
            <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:bg-white/15 transition-colors">
              ...
              <p class="text-slate-400">info@biznespilot.uz</p>
            </div>
            ...
            <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:bg-white/15 transition-colors">
              ...
              <p class="text-slate-400">+998 50 504 86 68</p>
            </div>
            ...
            <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:bg-white/15 transition-colors">
              ...
              <p class="text-slate-400">Toshkent, O'zbekiston</p>
            </div>
          </div>
...
const modules = [
  {
    title: 'Marketing',
    description: "Barcha kanallar va mijozlar bir joyda",
  ...
  {
    title: 'Sotuv',
    description: "Har bir mijoz va kelishuv nazoratda",
  ...
  {
    title: 'HR',
    description: "Xodimlar va vazifalar shaffof",
  ...
  {
    title: 'Moliya',
    description: "Pul qayerda — doim ko'rinadi",
...
const features = [
  {
    ...
    description: "4 ta modul bitta tizimda. Marketing, Sotuv, HR, Moliya — hammasi bitta ekranda ko'rinadi. Tarqoq ma'lumotlar yo'q.",
  ...
  },
  {
    ...
    description: "Tizim muammolarni oldindan topadi, tavsiyalar beradi, takroriy ishlarni avtomatik bajaradi. 24/7 ishlaydi.",
  ...
  },
  {
    ...
    description: "Mahalliy integratsiyalar (Click, Payme, 1C), o'zbek va rus tillari, so'm valyutasi, mahalliy qo'llab-quvvatlash.",
...
const values = [
  {
    title: 'Ishonchlilik',
    description: "Mijozlar bilan ochiq va halol munosabatlar",
    iconBgClass: 'bg-gradient-to-br from-blue-500 to-indigo-600',
    icon: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>',
  },
  {
    title: 'Innovatsiya',
    description: "Doimiy ravishda yangi texnologiyalarni joriy etamiz",
    iconBgClass: 'bg-gradient-to-br from-emerald-500 to-teal-600',
    icon: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>',
  },
  {
    title: "Mijozga e'tibor",
    description: "Har bir qaror mijoz manfaatini ko'zlab",
    iconBgClass: 'bg-gradient-to-br from-violet-500 to-purple-600',
  ...
  },
  {
    ...
    description: "Mijozlarning real natijalariga e'tibor",
    iconBgClass: 'bg-gradient-to-br from-amber-500 to-orange-600',

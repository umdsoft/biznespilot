  ...
  <SalesHeadLayout title="KPI">
      ...
      <div class="flex items-center justify-between flex-wrap gap-4">
        <div>
          <h2 class="text-3xl font-bold text-gray-900 dark:text-gray-100">
            Sotuv KPI Ko'rsatkichlari
          </h2>
          <p class="mt-2 text-gray-600 dark:text-gray-400">
            Sotuv bo'limi samaradorlik ko'rsatkichlari va ularning bajarilishi
          </p>
          <!-- Action Buttons -->
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      ...
      <div class="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl shadow-lg p-6 text-white">
        ...
        <p class="text-emerald-100 text-sm font-medium mb-1">Jami KPI</p>
          ...
          <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
            <tr v-for="metric in kpiMetrics" :key="metric.name" class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-center">
                ...
                <div class="text-xs text-gray-500 dark:text-gray-400">{{ metric.targetLabel || 'Kunlik' }}</div>
              </td>
      ...
      <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
        <div class="flex items-center justify-between">
          <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
            {{ period === 'weekly' ? 'Haftalik' : 'Oylik' }} KPI Ko'rsatkichlari
          </h3>
          <span class="text-sm text-gray-500 dark:text-gray-400">{{ dateRange.current_month }}</span>
        </div>
      </div>
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          <thead class="bg-gray-50 dark:bg-gray-700">
            <tr>
              <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Ko'rsatkich</th>
              <th class="px-6 py-4 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Kategoriya</th>
              <th class="px-6 py-4 text-center text-xs font-medium uppercase bg-emerald-50 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300">Reja</th>
              <th class="px-6 py-4 text-center text-xs font-medium uppercase border-l-2 border-blue-500 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300">Hozirgi</th>
              <th class="px-6 py-4 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Bajarilishi</th>
              <th class="px-6 py-4 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Status</th>
            </tr>
          </thead>
    ...
    <div v-if="showAddPlanModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-lg w-full">
        <div class="border-b border-gray-200 dark:border-gray-700 px-6 py-4 flex items-center justify-between">
          <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100">Sotuv Rejasini Qo'shish</h3>
        ...
        <form @submit.prevent="savePlan" class="p-6 space-y-4">
          ...
          <div class="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-lg p-4">
            <p class="text-sm text-emerald-800 dark:text-emerald-300">
              <strong>Eslatma:</strong> Faqat <strong>Sotuvlar soni</strong> va <strong>O'rtacha chek</strong> kiriting. Qolgan ko'rsatkichlar avtomatik hisoblanadi.
            </p>
          </div>

          <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              Sotuvlar soni (dona) <span class="text-red-500">*</span>
            </label>
            <input
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              O'rtacha chek (so'm) <span class="text-red-500">*</span>
            </label>
            <input
          ...
          <div v-if="planForm.new_sales && planForm.avg_check" class="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
            <p class="text-sm text-gray-600 dark:text-gray-400">
              <strong>Hisoblangan daromad:</strong>
...
const getStatusLabel = (achievement) => {
  if (achievement >= 100) return 'Bajarildi';

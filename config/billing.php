...
return [
    ...
    */
    'urls' => [
        'success' => env('BILLING_SUCCESS_URL', '/business/billing/success'),
        'cancel' => env('BILLING_CANCEL_URL', '/business/billing/plans'),
        'fail' => env('BILLING_FAIL_URL', '/business/billing/plans'),
    ],

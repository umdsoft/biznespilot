    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="text-center mb-16 animate-on-scroll">
            <div class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-500/30 rounded-full text-sm font-medium text-blue-300 mb-6 backdrop-blur-sm">
                ...
                <?php echo e($locale === 'ru' ? 'AI Модули' : 'AI Powered Modullar'); ?>

            </div>
            <h2 class="text-4xl lg:text-5xl font-bold text-white mb-6">
                <?php echo e($locale === 'ru' ? 'Мощные инструменты для' : 'Biznesingiz uchun'); ?>

                <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">
                    <?php echo e($locale === 'ru' ? 'вашего бизнеса' : 'kuchli vositalar'); ?>

                </span>
            </h2>
            <p class="text-xl text-slate-400 max-w-2xl mx-auto">
                <?php echo e($locale === 'ru' ? 'Каждый модуль создан для роста вашего бизнеса' : 'Har bir modul biznesingizni yangi darajaga olib chiqish uchun yaratilgan'); ?>
                                ...
                                <div>
                                    ...
                                    <ul class="space-y-4">
                                        <li class="flex items-center text-slate-300">
                                            ...
                                            <?php echo e($locale === 'ru' ? 'Автоматические DM кампании' : 'Avtomatik DM kampaniyalar'); ?>
                                        ...
                                        <li class="flex items-center text-slate-300">
                                            ...
                                            <?php echo e($locale === 'ru' ? 'Отслеживание вовлеченности' : 'Story va Post engagement tracking'); ?>
                                        ...
                                        <li class="flex items-center text-slate-300">
                                            ...
                                            <?php echo e($locale === 'ru' ? 'Lead scoring и сегментация' : 'Lead scoring va segmentatsiya'); ?>
                        ...
                        <div class="bg-gradient-to-br from-sky-500/10 to-blue-600/10 backdrop-blur-xl border border-white/10 rounded-3xl p-8 lg:p-12">
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                                <div>
                                    ...
                                    <h3 class="text-3xl lg:text-4xl font-bold text-white mb-6">
                                        <?php echo e($locale === 'ru' ? 'Telegram Воронка Продаж' : 'Telegram Sotuv Voronkasi'); ?>

                                    </h3>
                                    <p class="text-slate-300 text-lg mb-8 leading-relaxed">
                                        <?php echo e($locale === 'ru' ? 'Превращайте подписчиков Telegram канала в покупателей. Автоматические воронки, рассылки и AI-бот для продаж 24/7.' : 'Telegram kanaldagi obunachilarni xaridorlarga aylantiring. Avtomatik voronkalar, broadcast va 24/7 sotuv uchun AI-bot.'); ?>
                                    ...
                                    <ul class="space-y-4">
                                        <li class="flex items-center text-slate-300">
                                            ...
                                            <?php echo e($locale === 'ru' ? 'Автоматические воронки в боте' : 'Botda avtomatik voronkalar'); ?>
                                        ...
                                        <li class="flex items-center text-slate-300">
                                            ...
                                            <?php echo e($locale === 'ru' ? 'Массовые и сегментированные рассылки' : 'Ommaviy va segmentlangan broadcast'); ?>
                                        ...
                                        <li class="flex items-center text-slate-300">
                                            ...
                                            <?php echo e($locale === 'ru' ? 'Интеграция с CRM и оплатой' : 'CRM va to\'lov integratsiyasi'); ?>
                                    ...
                                    <svg viewBox="0 0 400 400" class="w-full max-w-md mx-auto" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <g transform="translate(60, 100)" filter="url(#tgShadow)">
                                            ...
                                            <g transform="translate(15, 75)">
                                                ...
                                                <text x="15" y="18" fill="#7dd3fc" font-size="11" font-weight="500"><?php echo e($locale === 'ru' ? 'Привет! Чем помочь?' : 'Salom! Qanday yordam?'); ?></text>
                                            ...
                                            <g transform="translate(85, 130)">
                                                ...
                                                <text x="15" y="24" fill="#e2e8f0" font-size="11"><?php echo e($locale === 'ru' ? 'Хочу купить курс' : 'Kurs sotib olmoqchiman'); ?></text>
                                            </g>
                                            ...
                                            <g transform="translate(15, 180)">
                                                ...
                                                <text x="15" y="18" fill="#7dd3fc" font-size="11" font-weight="500"><?php echo e($locale === 'ru' ? 'Отлично! Вот ссылка' : 'Ajoyib! Mana havola'); ?></text>
                                                <!-- Payment button -->
                                                <rect x="15" y="30" width="120" height="22" rx="8" fill="#22c55e"/>
                                                <text x="75" y="45" text-anchor="middle" fill="white" font-size="10" font-weight="bold">💳 <?php echo e($locale === 'ru' ? 'Оплатить' : 'To\'lov qilish'); ?></text>
                                            </g>
                        ...
                        <div class="bg-gradient-to-br from-blue-600/10 to-indigo-700/10 backdrop-blur-xl border border-white/10 rounded-3xl p-8 lg:p-12">
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                                <div>
                                    ...
                                    <h3 class="text-3xl lg:text-4xl font-bold text-white mb-6">
                                        <?php echo e($locale === 'ru' ? 'Facebook Ads Менеджер' : 'Facebook Ads Menejer'); ?>

                                    </h3>
                                    <p class="text-slate-300 text-lg mb-8 leading-relaxed">
                                        <?php echo e($locale === 'ru' ? 'Управляйте рекламными кампаниями Facebook и Instagram из одной панели. AI оптимизирует бюджет и таргетинг автоматически.' : 'Facebook va Instagram reklama kampaniyalarini bitta paneldan boshqaring. AI byudjet va targetingni avtomatik optimizatsiya qiladi.'); ?>
                                    ...
                                    <ul class="space-y-4">
                                        <li class="flex items-center text-slate-300">
                                            ...
                                            <?php echo e($locale === 'ru' ? 'Автоматическая оптимизация бюджета' : 'Avtomatik byudjet optimizatsiyasi'); ?>
                                        ...
                                        <li class="flex items-center text-slate-300">
                                            ...
                                            <?php echo e($locale === 'ru' ? 'A/B тестирование креативов' : 'Kreativlar A/B testing'); ?>
                                        ...
                                        <li class="flex items-center text-slate-300">
                                            ...
                                            <?php echo e($locale === 'ru' ? 'ROI отслеживание в реальном времени' : 'Real-time ROI tracking'); ?>
                                ...
                                <div class="relative">
                                    <svg viewBox="0 0 400 400" class="w-full max-w-md mx-auto" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <g transform="translate(45, 195)">
                                            ...
                                            <text x="15" y="22" fill="#94a3b8" font-size="11" font-weight="500"><?php echo e($locale === 'ru' ? 'Расход и конверсии' : 'Xarajat va konversiya'); ?></text>
                                        ...
                                        <g transform="translate(45, 322)">
                                            ...
                                            <text x="48" y="18" text-anchor="middle" fill="#60a5fa" font-size="9"><?php echo e($locale === 'ru' ? 'Показы' : 'Ko\'rishlar'); ?></text>
                                        ...
                                        <g transform="translate(150, 322)">
                                            ...
                                            <text x="48" y="18" text-anchor="middle" fill="#4ade80" font-size="9"><?php echo e($locale === 'ru' ? 'Клики' : 'Kliklar'); ?></text>
                                        ...
                                        <g transform="translate(255, 322)">
                                            ...
                                            <text x="48" y="18" text-anchor="middle" fill="#fbbf24" font-size="9"><?php echo e($locale === 'ru' ? 'Конверсии' : 'Konversiya'); ?></text>
                        ...
                        <div class="bg-gradient-to-br from-emerald-500/10 to-teal-600/10 backdrop-blur-xl border border-white/10 rounded-3xl p-8 lg:p-12">
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                                <div>
                                    ...
                                    <h3 class="text-3xl lg:text-4xl font-bold text-white mb-6">
                                        <?php echo e($locale === 'ru' ? 'AI Чатбот Продаж' : 'AI Sotuv Chatbot'); ?>

                                    </h3>
                                    <p class="text-slate-300 text-lg mb-8 leading-relaxed">
                                        <?php echo e($locale === 'ru' ? 'Работает на основе скрипта продаж. Отвечает клиентам 24/7, обрабатывает возражения и закрывает сделки.' : 'Sotuv skripti asosida ishlaydigan AI chatbot. Mijozlarning savollariga 24/7 javob beradi, e\'tirozlarni bartaraf etadi va sotuvni yopadi.'); ?>
                                    ...
                                    <ul class="space-y-4">
                                        <li class="flex items-center text-slate-300">
                                            ...
                                            <?php echo e($locale === 'ru' ? 'Ответы по скрипту продаж' : 'Sotuv skripti bo\'yicha javob beradi'); ?>
                                        ...
                                        <li class="flex items-center text-slate-300">
                                            ...
                                            <?php echo e($locale === 'ru' ? 'Умная обработка возражений' : 'E\'tirozlarni aqlli qayta ishlaydi'); ?>
                                        ...
                                        <li class="flex items-center text-slate-300">
                                            ...
                                            <?php echo e($locale === 'ru' ? 'Автоматическая передача оператору' : 'Operatorga avtomatik uzatish'); ?>
                                ...
                                <div class="relative">
                                    <svg viewBox="0 0 400 400" class="w-full max-w-md mx-auto" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <g transform="translate(40, 75)" filter="url(#aiShadow)">
                                            ...
                                            <!-- Bot info with pulse -->
                                            <text x="70" y="25" fill="white" font-size="14" font-weight="bold"><?php echo e($locale === 'ru' ? 'Ассистент' : 'Sotuv Assistenti'); ?></text>
                                            ...
                                            <g transform="translate(120, 75)">
                                                ...
                                                <text x="18" y="26" fill="white" font-size="12"><?php echo e($locale === 'ru' ? 'Сколько стоит?' : 'Narxi qancha?'); ?></text>
                                            </g>
                                            ...
                                            <g transform="translate(15, 130)">
                                                ...
                                                <text x="18" y="22" fill="white" font-size="11" font-weight="500"><?php echo e($locale === 'ru' ? 'Отличный вопрос! У нас' : 'Ajoyib savol! Bizda 3 ta'); ?></text>
                                                <text x="18" y="40" fill="white" font-size="11" font-weight="500"><?php echo e($locale === 'ru' ? '3 тарифа. Какой вам' : 'tarif mavjud. Sizga qaysi'); ?></text>
                                                <text x="18" y="58" fill="white" font-size="11" font-weight="500"><?php echo e($locale === 'ru' ? 'подходит?' : 'biri mos keladi?'); ?></text>
                                            </g>
                        ...
                        <div class="bg-gradient-to-br from-blue-500/10 to-indigo-600/10 backdrop-blur-xl border border-white/10 rounded-3xl p-8 lg:p-12">
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                                <div>
                                    ...
                                    <h3 class="text-3xl lg:text-4xl font-bold text-white mb-6">
                                        <?php echo e($locale === 'ru' ? 'Маркетинговый Алгоритм' : 'Marketing Algoritmi'); ?>

                                    </h3>
                                    <p class="text-slate-300 text-lg mb-8 leading-relaxed">
                                        <?php echo e($locale === 'ru' ? 'AI разрабатывает маркетинговую стратегию для вашего бизнеса. Какой контент, когда, какой аудитории - все определяется автоматически.' : 'AI sizning biznesingizga mos marketing strategiyasini ishlab chiqadi. Qaysi kontent, qaysi vaqtda, qaysi auditoriyaga - hammasini avtomatik aniqlaydi.'); ?>
                                    ...
                                    <ul class="space-y-4">
                                        <li class="flex items-center text-slate-300">
                                            ...
                                            <?php echo e($locale === 'ru' ? 'Автоматизация A/B тестирования' : 'A/B testing avtomatizatsiya'); ?>
                                        ...
                                        <li class="flex items-center text-slate-300">
                                            ...
                                            <?php echo e($locale === 'ru' ? 'Генерация контент-календаря' : 'Kontent kalendar generatsiyasi'); ?>
                                        ...
                                        <li class="flex items-center text-slate-300">
                                            ...
                                            <?php echo e($locale === 'ru' ? 'Анализ оптимального времени постинга' : 'Optimal posting vaqti tahlili'); ?>
                        ...
                        <div class="bg-gradient-to-br from-amber-500/10 to-orange-600/10 backdrop-blur-xl border border-white/10 rounded-3xl p-8 lg:p-12">
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                                <div>
                                    ...
                                    <h3 class="text-3xl lg:text-4xl font-bold text-white mb-6">
                                        <?php echo e($locale === 'ru' ? 'Анализ Операторов' : 'Call Operatorlar Tahlili'); ?>

                                    </h3>
                                    <p class="text-slate-300 text-lg mb-8 leading-relaxed">
                                        <?php echo e($locale === 'ru' ? 'AI анализирует каждый разговор: эффективность оператора, удовлетворенность клиента и возможности продаж. Коучинг в реальном времени.' : 'AI har bir suhbatni tahlil qiladi: operatorning samaradorligini, mijoz qoniqishini va sotuv imkoniyatlarini aniqlaydi. Real-time coaching.'); ?>
                                    ...
                                    <ul class="space-y-4">
                                        <li class="flex items-center text-slate-300">
                                            ...
                                            <?php echo e($locale === 'ru' ? 'Транскрипция и анализ разговоров' : 'Suhbat transkripsiyasi va tahlili'); ?>
                                        ...
                                        <li class="flex items-center text-slate-300">
                                            ...
                                            <?php echo e($locale === 'ru' ? 'Анализ настроения и эмоций' : 'Sentiment va emotion detection'); ?>
                                        ...
                                        <li class="flex items-center text-slate-300">
                                            ...
                                            <?php echo e($locale === 'ru' ? 'Оценка эффективности оператора' : 'Operator performance scoring'); ?>
                                    ...
                                    <svg viewBox="0 0 400 400" class="w-full max-w-md mx-auto" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <g transform="translate(50, 65)" filter="url(#callShadow)">
                                            ...
                                            <g transform="translate(15, 150)">
                                                ...
                                                <g transform="translate(15, 75)">
                                                    <text x="0" y="0" fill="#94a3b8" font-size="10"><?php echo e($locale === 'ru' ? 'Скрипт' : 'Skript'); ?></text>
                                                    <rect x="75" y="-10" width="150" height="14" rx="5" fill="#0f172a"/>
                                                ...
                                                <g transform="translate(15, 105)">
                                                    <text x="0" y="0" fill="#94a3b8" font-size="10"><?php echo e($locale === 'ru' ? 'Оценка' : 'Baholash'); ?></text>
                                                    <rect x="75" y="-10" width="150" height="14" rx="5" fill="#0f172a"/>
                        ...
                        <div class="bg-gradient-to-br from-emerald-500/10 to-green-600/10 backdrop-blur-xl border border-white/10 rounded-3xl p-8 lg:p-12">
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                                <div>
                                    <div class="inline-flex items-center px-3 py-1 bg-emerald-500/20 border border-emerald-500/30 rounded-full text-sm text-emerald-300 mb-6">
                                        <span class="w-2 h-2 bg-emerald-400 rounded-full mr-2 animate-pulse"></span>
                                        <?php echo e($locale === 'ru' ? 'Финансовый учет' : 'Moliyaviy boshqaruv'); ?>

                                    </div>
                                    <h3 class="text-3xl lg:text-4xl font-bold text-white mb-6">
                                        <?php echo e($locale === 'ru' ? 'Модуль Финансов' : 'Moliya Moduli'); ?>

                                    </h3>
                                    <p class="text-slate-300 text-lg mb-8 leading-relaxed">
                                        <?php echo e($locale === 'ru' ? 'Полный контроль над финансами бизнеса. Доходы, расходы, счета-фактуры, платежи и отчеты для бухгалтерии - все в одном месте.' : 'Biznes moliyasi ustidan to\'liq nazorat. Kirim-chiqim, fakturalar, to\'lovlar va buxgalteriya uchun hisobotlar - barchasi bir joyda.'); ?>
                                    ...
                                    <ul class="space-y-4">
                                        <li class="flex items-center text-slate-300">
                                            ...
                                            <?php echo e($locale === 'ru' ? 'Учет доходов и расходов' : 'Kirim-chiqim hisobi'); ?>
                                        ...
                                        <li class="flex items-center text-slate-300">
                                            ...
                                            <?php echo e($locale === 'ru' ? 'Счета-фактуры и платежи' : 'Fakturalar va to\'lovlar'); ?>
                                        ...
                                        <li class="flex items-center text-slate-300">
                                            ...
                                            <?php echo e($locale === 'ru' ? 'Отчеты для бухгалтерии' : 'Buxgalteriya hisobotlari'); ?>
                                ...
                                <div class="relative">
                                    <svg viewBox="0 0 400 400" class="w-full max-w-md mx-auto" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <g transform="translate(35, 65)" filter="url(#financeShadow)">
                                            ...
                                            <text x="20" y="35" fill="white" font-size="14" font-weight="bold"><?php echo e($locale === 'ru' ? 'Финансы' : 'Moliya Dashboard'); ?></text>
                                            ...
                                            <g transform="translate(15, 70)">
                                                ...
                                                <text x="18" y="22" fill="#94a3b8" font-size="11"><?php echo e($locale === 'ru' ? 'Общий баланс' : 'Umumiy balans'); ?></text>
                                            ...
                                            <g transform="translate(15, 160)">
                                                ...
                                                <text x="50" y="22" fill="#94a3b8" font-size="10"><?php echo e($locale === 'ru' ? 'Доходы' : 'Kirim'); ?></text>
                                                ...
                                                <g transform="translate(155, 0)">
                                                    ...
                                                    <text x="50" y="22" fill="#94a3b8" font-size="10"><?php echo e($locale === 'ru' ? 'Расходы' : 'Chiqim'); ?></text>
                                            ...
                                            <g transform="translate(15, 245)">
                                                ...
                                                <text x="15" y="18" fill="#94a3b8" font-size="10" font-weight="500"><?php echo e($locale === 'ru' ? 'Денежный поток' : 'Pul oqimi'); ?></text>
                        ...
                        <div class="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 backdrop-blur-xl border border-white/10 rounded-3xl p-8 lg:p-12">
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                                <div>
                                    ...
                                    <h3 class="text-3xl lg:text-4xl font-bold text-white mb-6">
                                        <?php echo e($locale === 'ru' ? 'Модуль KPI' : 'KPI Moduli'); ?>

                                    </h3>
                                    <p class="text-slate-300 text-lg mb-8 leading-relaxed">
                                        <?php echo e($locale === 'ru' ? 'Отслеживайте ключевые показатели бизнеса в реальном времени. Ставьте цели, следите за прогрессом и повышайте эффективность команды.' : 'Biznesingizning asosiy ko\'rsatkichlarini real vaqtda kuzating. Maqsadlar qo\'ying, progressni tracking qiling va jamoa samaradorligini oshiring.'); ?>
                                    ...
                                    <ul class="space-y-4">
                                        <li class="flex items-center text-slate-300">
                                            ...
                                            <?php echo e($locale === 'ru' ? 'Real-time KPI дашборды' : 'Real-time KPI dashboardlar'); ?>
                                        ...
                                        <li class="flex items-center text-slate-300">
                                            ...
                                            <?php echo e($locale === 'ru' ? 'Постановка и отслеживание целей' : 'Goal setting va tracking'); ?>
                                        ...
                                        <li class="flex items-center text-slate-300">
                                            ...
                                            <?php echo e($locale === 'ru' ? 'Лидерборды и геймификация' : 'Team leaderboards va gamification'); ?>
                                    ...
                                    <svg viewBox="0 0 400 400" class="w-full max-w-md mx-auto" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <g transform="translate(35, 65)" filter="url(#kpiShadow)">
                                            ...
                                            <g transform="translate(15, 220)">
                                                ...
                                                <text x="12" y="20" fill="#94a3b8" font-size="9"><?php echo e($locale === 'ru' ? 'Продажи' : 'Sotuvlar'); ?></text>
                                                ...
                                                <g transform="translate(110, 0)">
                                                    ...
                                                    <text x="12" y="20" fill="#94a3b8" font-size="9"><?php echo e($locale === 'ru' ? 'Лиды' : 'Leadlar'); ?></text>
                                                ...
                                                <g transform="translate(220, 0)">
                                                    ...
                                                    <text x="12" y="20" fill="#94a3b8" font-size="9"><?php echo e($locale === 'ru' ? 'Конверсия' : 'Konversiya'); ?></text>
...
function featuresCarousel() {
    return {
        ...
        slides: [
            ...
            { name: '<?php echo e($locale === "ru" ? "AI Чатбот" : "AI Chatbot"); ?>' },
            { name: '<?php echo e($locale === "ru" ? "Маркетинг" : "Marketing"); ?>' },
            { name: '<?php echo e($locale === "ru" ? "Анализ звонков" : "Call Tahlili"); ?>' },
            { name: '<?php echo e($locale === "ru" ? "Финансы" : "Moliya"); ?>' },
            { name: 'KPI' }
        ],
...
<?php /**PATH D:\marketing startap\biznespilot\resources\views/landing/partials/features-carousel.blade.php ENDPATH**/ ?>
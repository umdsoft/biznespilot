        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-12">
                ...
                <p class="text-gray-600">
                    <?php if($locale === 'ru'): ?>
                        Последнее обновление: <?php echo e(now()->format('d.m.Y')); ?>

                    <?php else: ?>
                        Oxirgi yangilanish: <?php echo e(now()->format('d.m.Y')); ?>
            ...
            <div class="bg-white rounded-3xl shadow-xl p-8 md:p-12 space-y-8">
                ...
                <section>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="bg-gray-50 rounded-xl p-5">
                            ...
                            ?>
                            <ul class="space-y-2 text-gray-700">
                                <?php $__currentLoopData = $responsibilities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="flex items-start">
                ...
                <section>
                    ...
                    <div class="bg-red-50 rounded-xl p-5 border border-red-100">
                        ...
                        <div class="grid sm:grid-cols-2 gap-3">
                            <?php $__currentLoopData = $obligations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $obligation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <section>
                    ...
                    <div class="grid sm:grid-cols-2 gap-3">
                        <?php $__currentLoopData = $availabilityReasons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reason): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center p-3 bg-amber-50 rounded-lg border border-amber-100">
                            <svg class="w-5 h-5 text-amber-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($reason['icon']); ?>"/>
                            </svg>
                            <span class="text-amber-800 text-sm"><?php echo e($reason['text']); ?></span>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-violet-50 to-purple-50 rounded-xl p-6 border border-violet-100">
                        ...
                        <div class="space-y-2">
                            <p class="flex items-center text-gray-800">
                                ...
                                <strong><?php echo e($locale === 'ru' ? 'Компания:' : 'Kompaniya:'); ?></strong>&nbsp; BiznesPilot
                            </p>
                            <p class="flex items-center text-gray-800">
                                <svg class="w-5 h-5 text-violet-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <p class="flex items-center text-gray-800">
                                ...
                                <strong><?php echo e($locale === 'ru' ? 'Телефон:' : 'Telefon:'); ?></strong>&nbsp; +998 50 504 86 68
                            </p>
                            <p class="flex items-center text-gray-800">
                                <svg class="w-5 h-5 text-violet-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                </svg>
                                <strong><?php echo e($locale === 'ru' ? 'Часы работы:' : 'Ish vaqti:'); ?></strong>&nbsp; <?php echo e($locale === 'ru' ? 'Понедельник - Пятница, 09:00 - 18:00' : 'Dushanba - Juma, 09:00 - 18:00'); ?>
...
<?php echo $__env->make('landing.layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\marketing startap\biznespilot\resources\views\pages\terms.blade.php ENDPATH**/ ?>
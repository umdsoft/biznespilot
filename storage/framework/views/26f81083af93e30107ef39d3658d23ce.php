...
<body>
    <div class="container">
        ...
        <p style="text-align: center; color: #6B7280;">
            Hurmatli <?php echo e($user->name ?? 'Foydalanuvchi'); ?>, sizning to'lovingiz qabul qilindi.
        </p>

        <div class="amount">
            <?php echo e(number_format($transaction->amount, 0, ',', ' ')); ?> so'm
        </div>
        ...
        <div class="details">
            ...
            <div class="details-row">
                ...
                <span class="details-value"><?php echo e(ucfirst($transaction->provider)); ?></span>
            </div>
            <div class="details-row">
            ...
            <div class="details-row">
                ...
                <span class="details-value"><?php echo e($transaction->performed_at?->format('d.m.Y H:i') ?? now()->format('d.m.Y H:i')); ?></span>
            </div>
        </div>
        ...
        <a href="<?php echo e(config('app.url')); ?>/dashboard" class="cta-button">
            Dashboard'ga o'tish
        </a>
...
<?php /**PATH D:\marketing startap\biznespilot\resources\views\emails\billing\payment-success.blade.php ENDPATH**/ ?>
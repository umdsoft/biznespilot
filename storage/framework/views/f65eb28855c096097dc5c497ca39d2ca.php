    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16 lg:h-20">
            ...
            <nav class="hidden lg:flex items-center space-x-8">
                <a href="<?php echo e($baseUrl); ?>#features" class="text-gray-600 hover:text-gray-900 font-medium transition-colors">
                    <?php echo e($translations['nav']['features']); ?>

                </a>
                <a href="<?php echo e($baseUrl); ?>#how-it-works" class="text-gray-600 hover:text-gray-900 font-medium transition-colors">
                    <?php echo e($translations['nav']['how_it_works']); ?>

                </a>
                <a href="<?php echo e($baseUrl); ?>#benefits" class="text-gray-600 hover:text-gray-900 font-medium transition-colors">
                    <?php echo e($translations['nav']['benefits']); ?>

                </a>
                <a href="<?php echo e($isPricingPage ? '#' : '#pricing'); ?>" class="<?php echo e($isPricingPage ? 'text-blue-600 font-semibold' : 'text-gray-600 hover:text-gray-900 font-medium'); ?> transition-colors">
                    <?php echo e($translations['nav']['pricing']); ?>

                </a>
                <a href="<?php echo e($baseUrl); ?>#faq" class="text-gray-600 hover:text-gray-900 font-medium transition-colors">
        ...
        <div id="mobile-menu" class="mobile-menu lg:hidden">
            <div class="py-4 space-y-2 border-t border-gray-100">
                <a href="<?php echo e($baseUrl); ?>#features" class="block px-4 py-2 text-gray-600 hover:bg-gray-50 rounded-lg">
                    <?php echo e($translations['nav']['features']); ?>

                </a>
                <a href="<?php echo e($baseUrl); ?>#how-it-works" class="block px-4 py-2 text-gray-600 hover:bg-gray-50 rounded-lg">
                    <?php echo e($translations['nav']['how_it_works']); ?>

                </a>
                <a href="<?php echo e($baseUrl); ?>#benefits" class="block px-4 py-2 text-gray-600 hover:bg-gray-50 rounded-lg">
                    <?php echo e($translations['nav']['benefits']); ?>

                </a>
                <a href="<?php echo e($isPricingPage ? '#' : '#pricing'); ?>" class="block px-4 py-2 <?php echo e($isPricingPage ? 'text-blue-600 font-semibold bg-blue-50' : 'text-gray-600 hover:bg-gray-50'); ?> rounded-lg">
                    <?php echo e($translations['nav']['pricing']); ?>

                </a>
                <a href="<?php echo e($baseUrl); ?>#faq" class="block px-4 py-2 text-gray-600 hover:bg-gray-50 rounded-lg">
                    <?php echo e($translations['nav']['faq']); ?>
...
<?php /**PATH D:\marketing startap\biznespilot\resources\views/landing/partials/header.blade.php ENDPATH**/ ?>
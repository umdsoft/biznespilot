            ...
            <div class="order-1 lg:order-2">
                ...
                <div class="space-y-6">
                    ...
                    <?php $__currentLoopData = $translations['benefits']['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $benefit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $data = $benefitData[$benefit['icon']] ?? $benefitData['clock']; ?>
                        <div class="animate-on-scroll group" style="animation-delay: <?php echo e($index * 0.1); ?>s;">
                            <div class="flex items-start gap-5 p-6 rounded-2xl hover:bg-gray-50 transition-all duration-300 cursor-pointer border border-transparent hover:border-gray-100">
                                <!-- Icon -->
                                <div class="flex-shrink-0 w-14 h-14 bg-gradient-to-br <?php echo e($data['gradient']); ?> rounded-2xl flex items-center justify-center text-2xl shadow-lg group-hover:scale-110 transition-transform duration-300">
                                ...
                                <!-- Content -->
                                <div class="flex-1">
                                    <h3 class="text-xl font-bold text-gray-900 mb-2 <?php echo e($data['hoverText']); ?> transition-colors">
                                    ...
                                    <div class="flex flex-wrap gap-2 text-xs">
                                        <span class="px-2 py-1 bg-red-50 text-red-600 rounded-full line-through"><?php echo e($benefit['before']); ?></span>
                                        <span class="px-2 py-1 bg-green-50 text-green-600 rounded-full font-semibold"><?php echo e($benefit['after']); ?></span>
                                    </div>
                                    <?php endif; ?>
                                </div>

                                <!-- Arrow -->
                                <div class="flex-shrink-0 w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 <?php echo e($data['arrowBg']); ?>">
                                    <svg class="w-4 h-4 <?php echo e($data['arrowText']); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">

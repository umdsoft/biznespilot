    ...
    <main class="pt-24 pb-16 min-h-screen gradient-bg">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-3xl shadow-xl p-8 md:p-12 space-y-8">
                ...
                <section>
                    ...
                    <div class="space-y-3">
                        ...
                        <?php $__currentLoopData = $rights; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $right): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-start p-4 bg-gray-50 rounded-xl">
                            <span class="w-8 h-8 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center text-sm font-bold mr-4 flex-shrink-0"><?php echo e($index + 1); ?></span>
                            <div>
                                <h4 class="font-semibold text-gray-900"><?php echo e($right[0]); ?></h4>
                                <p class="text-sm text-gray-600"><?php echo e($right[1]); ?></p>
                            </div>
                        </div>
                    ...
                    <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-100">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="flex items-center text-gray-800">
                                ...
                                <strong><?php echo e($locale === 'ru' ? 'Адрес:' : 'Manzil:'); ?></strong>&nbsp; <?php echo e($locale === 'ru' ? 'г. Ташкент, Узбекистан' : "Toshkent shahri, O'zbekiston"); ?>
            ...
            <div class="text-center mt-8">
                <a href="<?php echo e(route('landing')); ?>" class="inline-flex items-center text-blue-600 hover:text-blue-700 font-medium">
...
<?php echo $__env->make('landing.layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\marketing startap\biznespilot\resources\views/pages/privacy.blade.php ENDPATH**/ ?>
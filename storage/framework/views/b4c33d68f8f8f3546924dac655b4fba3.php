<?php $__env->startSection('content'); ?>
    ...
    <section class="pt-32 pb-12 bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <div class="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm border border-gray-200 rounded-full text-sm mb-6 animate-on-scroll shadow-sm">
                ...
                <span class="text-gray-600"><strong class="text-gray-900">100+</strong> <?php echo e($locale === 'ru' ? 'компаний уже используют' : 'kompaniya allaqachon foydalanmoqda'); ?></span>
            </div>
            ...
            <div class="mt-8 inline-flex items-center gap-3 px-6 py-3 bg-green-50 border border-green-200 rounded-2xl animate-on-scroll">
                ...
                <div class="text-left">
                    <p class="font-semibold text-green-800"><?php echo e($locale === 'ru' ? '14 дней бесплатно' : '14 kun bepul sinov'); ?></p>
                    <p class="text-sm text-green-600"><?php echo e($locale === 'ru' ? 'Карта не требуется • Полный доступ' : 'Karta kerak emas • To\'liq kirish'); ?></p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex justify-center mb-12">
                <div class="relative inline-flex items-center p-1.5 bg-white rounded-2xl shadow-xl border border-gray-100">
                    ...
                    >
                        <?php echo e($locale === 'ru' ? 'Ежемесячно' : 'Oylik'); ?>
                    ...
                    <button
                        ...
                        :class="isYearly ? 'text-white' : 'text-gray-500 hover:text-gray-700'"
                    >
                        <?php echo e($locale === 'ru' ? 'Ежегодно' : 'Yillik'); ?>
            ...
            <div x-show="isYearly" x-transition:enter="transition ease-out duration-300"
                ...
                <div class="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-full text-green-700 font-semibold shadow-sm">
                    ...
                    <?php echo e($locale === 'ru' ? '2 месяца бесплатно при годовой оплате!' : 'Yillik to\'lovda 2 oy bepul!'); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 lg:gap-8 items-stretch">
                <?php $__currentLoopData = $pricingPlans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <div class="relative group <?php echo e($isPopular ? 'xl:-mt-6 xl:mb-6' : ''); ?>"
                         style="animation: fadeInUp 0.6s ease-out <?php echo e($index * 0.1); ?>s both;">

                        
                        <?php if($isPopular): ?>
                            <div class="absolute -inset-[2px] bg-gradient-to-b <?php echo e($scheme['gradient']); ?> rounded-[26px] opacity-100"></div>
                        <?php elseif($isPremium): ?>
                            <div class="absolute -inset-[2px] bg-gradient-to-b <?php echo e($scheme['gradient']); ?> rounded-[26px] opacity-100"></div>
                        <?php endif; ?>

                        <div class="relative h-full bg-white rounded-3xl <?php echo e(!$isPopular && !$isPremium ? 'border-2 ' . $scheme['border'] : ''); ?> transition-all duration-500 flex flex-col overflow-hidden
                                    <?php echo e($isPopular ? 'shadow-2xl shadow-purple-500/20' : ($isPremium ? 'shadow-2xl shadow-amber-500/20' : 'shadow-lg hover:shadow-2xl')); ?>

                                    <?php echo e(!$isPopular && !$isPremium ? 'hover:-translate-y-2' : ''); ?>">

                            
                            <div class="h-1.5 bg-gradient-to-r <?php echo e($scheme['gradient']); ?>"></div>
                            ...
                            <div class="p-6 lg:p-8 flex flex-col flex-1 <?php echo e($isPopular || $isPremium ? 'pt-10' : ''); ?>">
                                
                                <div class="flex items-start gap-4 mb-6">
                                    <div class="w-14 h-14 rounded-2xl <?php echo e($scheme['icon_bg']); ?> flex items-center justify-center flex-shrink-0 shadow-sm">
                                        <svg class="w-7 h-7 <?php echo e($scheme['icon_color']); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                            <path d="<?php echo e($plan['icon']); ?>" />
                                        </svg>
                                    </div>
                                    <div>
                                        <h3 class="text-xl font-bold text-gray-900"><?php echo e($plan['name']); ?></h3>
                                        <p class="text-sm text-gray-500"><?php echo e($plan['description']); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div x-show="!isYearly">
                                        <div class="flex items-baseline gap-2">
                                            <span class="text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight"><?php echo e(number_format($plan['price'], 0, '', ',')); ?></span>
                                    ...
                                    <div x-show="isYearly" x-cloak>
                                        <div class="flex items-baseline gap-2">
                                            <span class="text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight"><?php echo e(number_format($yearlyPrice, 0, '', ',')); ?></span>
                                            <div class="flex flex-col">
                                                <span class="text-lg font-bold text-gray-700">so'm</span>
                                                <span class="text-xs text-gray-500 -mt-1">/oy</span>
                                            </div>
                                        ...
                                        <div class="mt-2 flex items-center gap-2 flex-wrap">
                                            <span class="text-gray-400 line-through text-sm"><?php echo e(number_format($plan['price'], 0, '', ',')); ?> so'm</span>
                                            <span class="px-2 py-0.5 bg-green-100 text-green-700 text-xs font-bold rounded-full">
                                                <?php echo e(number_format($yearlySaving, 0, '', ',')); ?> so'm tejash!
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <ul class="space-y-3.5 mb-8 flex-1">
                                    <?php $__currentLoopData = $plan['features']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="flex items-start gap-3">
                                            <div class="w-5 h-5 rounded-full bg-gradient-to-br <?php echo e($scheme['gradient']); ?> flex items-center justify-center flex-shrink-0 mt-0.5">
                                                <svg class="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                                                </svg>
                                            </div>
                                            <span class="text-gray-700 text-sm lg:text-base"><?php echo e($feature); ?></span>
                                        </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>

                                
                                <a href="<?php echo e(route('register')); ?>?plan=<?php echo e($plan['id']); ?>"
                                   class="block w-full py-4 px-6 rounded-xl font-bold text-center text-base transition-all duration-300 transform hover:scale-[1.02] hover:-translate-y-0.5 <?php echo e($scheme['btn']); ?>">
                                    <?php echo e($isPopular ? ($locale === 'ru' ? 'Начать бесплатно' : 'Bepul Boshlash') : ($isPremium ? ($locale === 'ru' ? 'Получить Premium' : 'Premium olish') : ($locale === 'ru' ? 'Начать' : ($index === 1 ? 'Tanlash' : 'Boshlash')))); ?>
            ...
            <div class="mt-14 flex flex-wrap items-center justify-center gap-6 lg:gap-10">
                ...
                <div class="flex items-center gap-2.5 text-gray-500 group">
                    ...
                    <span class="text-sm font-medium"><?php echo e($locale === 'ru' ? 'Отмена в любое время' : 'Istalgan vaqt bekor qilish'); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-10 animate-on-scroll">
                <span class="inline-block px-4 py-1.5 bg-green-100 text-green-700 rounded-full text-sm font-medium mb-4">
                    💰 <?php echo e($locale === 'ru' ? 'Калькулятор экономии' : 'Tejash kalkulyatori'); ?>

                </span>
                <h2 class="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
                    <?php echo e($locale === 'ru' ? 'Сколько вы сэкономите?' : 'Qancha tejaysiz?'); ?>
                ...
                <div class="grid md:grid-cols-2">
                    ...
                    <div class="p-8 lg:p-10 border-b md:border-b-0 md:border-r border-gray-100">
                        <h3 class="text-lg font-semibold text-gray-900 mb-6 flex items-center gap-2">
                            ...
                            <?php echo e($locale === 'ru' ? 'Отдельно покупать' : 'Alohida sotib olsangiz'); ?>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center justify-between p-4 bg-red-50 rounded-xl border border-red-200 mt-4">
                                <span class="text-red-700 font-semibold"><?php echo e($locale === 'ru' ? 'Итого отдельно' : 'Jami alohida'); ?></span>
                                <span class="font-bold text-red-600 text-xl line-through">1,450,000 <?php echo e($locale === 'ru' ? 'сум' : 'so\'m'); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-8 lg:p-10 bg-gradient-to-br from-green-50 to-emerald-50 flex flex-col justify-center">
                        ...
                        <div class="text-center mb-6">
                            <div class="inline-block px-6 py-8 bg-white rounded-2xl shadow-lg border border-green-200">
                                <p class="text-sm text-gray-500 mb-1"><?php echo e($locale === 'ru' ? 'Все включено' : 'Hammasi kiritilgan'); ?></p>
                                <p class="text-5xl font-bold text-gray-900 mb-1">799,000</p>
                                <p class="text-gray-500"><?php echo e($locale === 'ru' ? 'сум/мес' : 'so\'m/oy'); ?></p>
                            </div>
                        </div>

                        <div class="bg-green-100 rounded-xl p-4 text-center mb-6">
                            <p class="text-green-800 font-bold text-2xl">
                                <?php echo e($locale === 'ru' ? 'Экономия 651,000 сум!' : '651,000 so\'m tejaysiz!'); ?>

                            </p>
                            <p class="text-green-600 text-sm mt-1">
                                <?php echo e($locale === 'ru' ? '45% экономия каждый месяц' : 'Har oy 45% tejash'); ?>
                        ...
                        <ul class="space-y-2 text-sm text-gray-600">
                            <li class="flex items-center gap-2">
                                ...
                                <?php echo e($locale === 'ru' ? 'Все в одном месте' : 'Hammasi bir joyda'); ?>
                            ...
                            <li class="flex items-center gap-2">
                                ...
                                <?php echo e($locale === 'ru' ? 'Без интеграций' : 'Integratsiyalarsiz'); ?>
                            ...
                            <li class="flex items-center gap-2">
                                ...
                                <?php echo e($locale === 'ru' ? 'Единая аналитика' : 'Yagona analitika'); ?>

                            </li>
                        </ul>

                        <a href="<?php echo e(route('register')); ?>?plan=business"
                           class="mt-6 block w-full py-3.5 px-6 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-semibold rounded-xl text-center hover:from-green-600 hover:to-emerald-700 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                            <?php echo e($locale === 'ru' ? 'Начать экономить' : 'Tejashni boshlash'); ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12 animate-on-scroll">
                <span class="inline-block px-4 py-1.5 bg-blue-100 text-blue-700 rounded-full text-sm font-medium mb-4">
                    <?php echo e($locale === 'ru' ? 'Подробное сравнение' : 'Batafsil solishtirish'); ?>

                </span>
                <h2 class="text-3xl sm:text-4xl font-bold text-gray-900 mb-4"><?php echo e($translations['pricing_page']['compare_title'] ?? 'Barcha imkoniyatlarni solishtiring'); ?></h2>
                <p class="text-lg text-gray-600 max-w-2xl mx-auto"><?php echo e($translations['pricing_page']['compare_subtitle'] ?? 'Har bir tarifda nimalar bor - batafsil jadval'); ?></p>
            </div>

            <div class="bg-white rounded-3xl border border-gray-200 shadow-xl overflow-hidden animate-on-scroll">
                <?php echo $__env->make('landing.partials.pricing-comparison-table', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-white" id="faq">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12 animate-on-scroll">
                <span class="inline-block px-4 py-1.5 bg-blue-100 text-blue-700 rounded-full text-sm font-medium mb-4">
                    <?php echo e($translations['pricing_page']['faq_badge'] ?? 'Savollar va javoblar'); ?>

                </span>
                <h2 class="text-3xl sm:text-4xl font-bold text-gray-900 mb-4"><?php echo e($translations['pricing_page']['faq_title'] ?? "Ko'p so'raladigan savollar"); ?></h2>
            </div>

            <div class="space-y-4" x-data="{ openFaq: null }">
                <?php $__currentLoopData = $translations['pricing_page']['faqs'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-gray-50 rounded-2xl border border-gray-200 overflow-hidden hover:border-blue-300 hover:shadow-lg transition-all duration-300 animate-on-scroll">
                        ...
                        >
                            ...
                            <div class="flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300"
                                 :class="openFaq === <?php echo e($index); ?> ? 'bg-blue-600 text-white rotate-180' : 'bg-gray-200 text-gray-600'">
                        ...
                        <div
                            x-show="openFaq === <?php echo e($index); ?>"
                            x-collapse
                            class="px-6 pb-6"
                        >
            ...
            <div class="mt-12 text-center animate-on-scroll">
                <p class="text-gray-600 mb-4"><?php echo e($locale === 'ru' ? 'Остались вопросы?' : 'Hali savollaringiz bormi?'); ?></p>
    ...
    <section class="py-20 bg-gradient-to-br from-blue-600 via-indigo-600 to-violet-600 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <h2 class="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6 animate-on-scroll">
                <?php echo e($locale === 'ru' ? 'Готовы начать?' : 'Boshlashga tayyormisiz?'); ?>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4 animate-on-scroll">
                <a href="<?php echo e(route('register')); ?>"
                   class="inline-flex items-center px-8 py-4 bg-white text-blue-600 text-lg font-bold rounded-xl hover:bg-blue-50 transition-all shadow-2xl hover:shadow-3xl transform hover:-translate-y-1">
                    <?php echo e($locale === 'ru' ? 'Начать бесплатно' : 'Bepul boshlash'); ?>
                ...
                <a href="https://t.me/biznespilot" target="_blank"
                   class="inline-flex items-center px-8 py-4 bg-white/10 backdrop-blur-sm text-white text-lg font-semibold rounded-xl hover:bg-white/20 transition-all border border-white/20">
                    ...
                    <?php echo e($locale === 'ru' ? 'Демо в Telegram' : 'Telegram demo'); ?>
...
<?php echo $__env->make('landing.layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\marketing startap\biznespilot\resources\views\landing\pricing.blade.php ENDPATH**/ ?>
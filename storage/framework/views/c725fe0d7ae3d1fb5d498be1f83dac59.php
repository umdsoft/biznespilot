    ...
    <main class="pt-24 min-h-screen">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div class="text-center max-w-3xl mx-auto">
                    ...
                    <h1 class="text-5xl font-bold text-gray-900 mb-6">
                        <?php echo e($locale === 'ru' ? 'О' : ''); ?> <span class="gradient-text">BiznesPilot</span><?php echo e($locale === 'ru' ? '' : ' haqida'); ?>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    <h2 class="text-3xl font-bold text-gray-900 mb-4">
                        <?php echo e($locale === 'ru' ? 'Что такое Бизнес Операционная Система?' : 'Biznes Operatsion Tizimi nima?'); ?>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-100">
                        ...
                        <h3 class="text-lg font-bold text-gray-900 mb-2"><?php echo e($locale === 'ru' ? 'Маркетинг' : 'Marketing'); ?></h3>
                        <p class="text-gray-600 text-sm">
                            <?php echo e($locale === 'ru' ? 'Все каналы и клиенты в одном месте' : "Barcha kanallar va mijozlar bir joyda"); ?>
                    ...
                    <div class="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-6 border border-emerald-100">
                        ...
                        <h3 class="text-lg font-bold text-gray-900 mb-2"><?php echo e($locale === 'ru' ? 'Продажи' : 'Sotuv'); ?></h3>
                        <p class="text-gray-600 text-sm">
                            <?php echo e($locale === 'ru' ? 'Каждый клиент и сделка под контролем' : "Har bir mijoz va kelishuv nazoratda"); ?>
                    ...
                    <div class="bg-gradient-to-br from-violet-50 to-purple-50 rounded-2xl p-6 border border-violet-100">
                        ...
                        <p class="text-gray-600 text-sm">
                            <?php echo e($locale === 'ru' ? 'Сотрудники и задачи прозрачны' : "Xodimlar va vazifalar shaffof"); ?>
                    ...
                    <div class="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-6 border border-amber-100">
                        ...
                        <h3 class="text-lg font-bold text-gray-900 mb-2"><?php echo e($locale === 'ru' ? 'Финансы' : 'Moliya'); ?></h3>
                        <p class="text-gray-600 text-sm">
                            <?php echo e($locale === 'ru' ? 'Где деньги — всегда видно' : "Pul qayerda — doim ko'rinadi"); ?>
                ...
                <div class="grid md:grid-cols-2 gap-12">
                    ...
                    <div class="relative">
                        ...
                        <div class="bg-white rounded-3xl p-8 border border-gray-200 shadow-lg">
                            ...
                            <h2 class="text-2xl font-bold text-gray-900 mb-4">
                                <?php echo e($locale === 'ru' ? 'Наша Миссия' : 'Bizning Missiyamiz'); ?>
                    ...
                    <div class="relative">
                        ...
                        <div class="bg-white rounded-3xl p-8 border border-gray-200 shadow-lg">
                            ...
                            <h2 class="text-2xl font-bold text-gray-900 mb-4">
                                <?php echo e($locale === 'ru' ? 'Наше Видение' : 'Bizning Visionimiz'); ?>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                    <div class="text-center">
                        ...
                        <div class="text-blue-100"><?php echo e($locale === 'ru' ? 'Основных модуля' : 'Asosiy modul'); ?></div>
                    </div>
                    <div class="text-center">
                        <div class="text-4xl lg:text-5xl font-bold text-white mb-2">100%</div>
                        <div class="text-blue-100"><?php echo e($locale === 'ru' ? 'Контроль' : 'Nazorat'); ?></div>
                    </div>
                    <div class="text-center">
                        <div class="text-4xl lg:text-5xl font-bold text-white mb-2">10 <?php echo e($locale === 'ru' ? 'мин' : 'daq'); ?></div>
                        <div class="text-blue-100"><?php echo e($locale === 'ru' ? 'Настройка' : "O'rnatish"); ?></div>
                    </div>
                    <div class="text-center">
                        <div class="text-4xl lg:text-5xl font-bold text-white mb-2">24/7</div>
                        <div class="text-blue-100"><?php echo e($locale === 'ru' ? 'Искусственный интеллект' : "Sun'iy intellekt"); ?></div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-20 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    <h2 class="text-3xl font-bold text-gray-900 mb-4">
                        <?php echo e($locale === 'ru' ? 'Почему именно BiznesPilot?' : 'Nega aynan BiznesPilot?'); ?>
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    ...
                    <div class="bg-gray-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-3">
                            <?php echo e($locale === 'ru' ? 'Полный контроль' : "To'liq nazorat"); ?>
                    ...
                    <div class="bg-gray-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-3">
                            <?php echo e($locale === 'ru' ? 'Искусственный интеллект' : "Sun'iy intellekt"); ?>
                    ...
                    <div class="bg-gray-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-3">
                            <?php echo e($locale === 'ru' ? 'Сделано для Узбекистана' : "O'zbekiston uchun yaratilgan"); ?>
        ...
        <section class="py-20 bg-gray-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    <h2 class="text-3xl font-bold text-gray-900 mb-4">
                        <?php echo e($locale === 'ru' ? 'Наши ценности' : 'Bizning qadriyatlarimiz'); ?>

                    </h2>
                    <p class="text-xl text-gray-600">
                        <?php echo e($locale === 'ru' ? 'Принципы, которыми мы руководствуемся' : "Biz amal qiladigan tamoyillar"); ?>
                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="text-center p-6 rounded-2xl bg-white border border-gray-200 shadow-sm">
                        ...
                        <h3 class="text-lg font-bold text-gray-900 mb-2">
                            <?php echo e($locale === 'ru' ? 'Надёжность' : 'Ishonchlilik'); ?>

                        </h3>
                        <p class="text-gray-600 text-sm">
                            <?php echo e($locale === 'ru' ? 'Открытые и честные отношения с клиентами' : "Mijozlar bilan ochiq va halol munosabatlar"); ?>
                    ...
                    <div class="text-center p-6 rounded-2xl bg-white border border-gray-200 shadow-sm">
                        ...
                        <h3 class="text-lg font-bold text-gray-900 mb-2">
                            <?php echo e($locale === 'ru' ? 'Инновации' : 'Innovatsiya'); ?>

                        </h3>
                        <p class="text-gray-600 text-sm">
                            <?php echo e($locale === 'ru' ? 'Постоянно внедряем новые технологии' : "Doimiy ravishda yangi texnologiyalarni joriy etamiz"); ?>
                    ...
                    <div class="text-center p-6 rounded-2xl bg-white border border-gray-200 shadow-sm">
                        ...
                        <h3 class="text-lg font-bold text-gray-900 mb-2">
                            <?php echo e($locale === 'ru' ? 'Клиентоориентированность' : "Mijozga e'tibor"); ?>

                        </h3>
                        <p class="text-gray-600 text-sm">
                            <?php echo e($locale === 'ru' ? 'Каждое решение в интересах клиента' : "Har bir qaror mijoz manfaatini ko'zlab"); ?>
                    ...
                    <div class="text-center p-6 rounded-2xl bg-white border border-gray-200 shadow-sm">
                        ...
                        <h3 class="text-lg font-bold text-gray-900 mb-2">
                            <?php echo e($locale === 'ru' ? 'Результативность' : "Natijaga yo'nalganlik"); ?>

                        </h3>
                        <p class="text-gray-600 text-sm">
                            <?php echo e($locale === 'ru' ? 'Фокус на реальных результатах клиентов' : "Mijozlarning real natijalariga e'tibor"); ?>
        ...
        <section class="py-20 bg-gradient-to-br from-gray-900 to-gray-800">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <h2 class="text-3xl font-bold text-white mb-4">
                    <?php echo e($locale === 'ru' ? 'Свяжитесь с нами' : "Biz bilan bog'laning"); ?>
                ...
                <div class="grid sm:grid-cols-3 gap-6 mb-8">
                    ...
                    <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
                        ...
                        <p class="text-white font-semibold mb-1"><?php echo e($locale === 'ru' ? 'Телефон' : 'Telefon'); ?></p>
                    ...
                    <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
                        ...
                        <p class="text-white font-semibold mb-1"><?php echo e($locale === 'ru' ? 'Адрес' : 'Manzil'); ?></p>
                        <p class="text-gray-400"><?php echo e($locale === 'ru' ? "Ташкент, Узбекистан" : "Toshkent, O'zbekiston"); ?></p>
                    </div>
                </div>
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                    ...
                    <a href="<?php echo e(route('landing')); ?>" class="inline-flex items-center px-8 py-4 bg-white text-gray-900 font-semibold rounded-xl hover:bg-gray-100 transition-colors">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"/>
                        </svg>
                        <?php echo e($locale === 'ru' ? 'Главная' : 'Bosh sahifa'); ?>
...
<?php echo $__env->make('landing.layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\marketing startap\biznespilot\resources\views\pages\about.blade.php ENDPATH**/ ?>
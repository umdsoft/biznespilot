...
class ContentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Shared/Content/Index', [
            'posts' => $contents,
            'stats' => $stats,
    ...
    public function show(Request $request, $id)
    {
        ...
        return Inertia::render('Shared/Content/Show', [
            'post' => [
                'id' => $content->id,
                'title' => $content->title,
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Inertia::render('Shared/Content/Edit', [
            'post' => [
                'id' => $content->id,
                'title' => $content->title,
                'content' => $content->content,
    ...
    public function destroy(Request $request, $id)
    {
        ...
        return redirect()->route("{$routePrefix}.content.index")
    ...
    public function analytics(Request $request)
    {
        ...
        return Inertia::render('Shared/Content/Analytics', [
            'analytics' => $analytics,

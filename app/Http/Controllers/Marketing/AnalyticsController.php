...
class AnalyticsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Marketing/Analytics/Index', [
            'overview' => $overview,
            'channels' => $channels,
    ...
    public function social(Request $request)
    {
        ...
        return Inertia::render('Marketing/Analytics/Social', [
    ...
    public function campaigns(Request $request)
    {
        ...
        return Inertia::render('Marketing/Analytics/Campaigns', [
    ...
    public function getInitialData(Request $request)
    {
        ...
        $cacheKey = "marketing_analytics_initial_{$business->id}_{$filterKey}";
    ...
    public function funnel(Request $request)
    {
        ...
        return Inertia::render('Marketing/Analytics/Funnel', [
            'filters' => $filters,
            'lazyLoad' => true,
        ]);
    }
    ...
    public function getFunnelData(Request $request)
    {
        ...
        $filters = $request->only(['date_from', 'date_to']);
        $cacheKey = "marketing_funnel_{$business->id}_".md5(json_encode($filters));
    ...
    public function getDreamBuyerPerformance(Request $request)
    {
        ...
        $filters = $request->only(['date_from', 'date_to']);
        $cacheKey = "marketing_dream_buyer_{$business->id}_".md5(json_encode($filters));
    ...
    public function getOfferPerformance(Request $request)
    {
        ...
        $filters = $request->only(['date_from', 'date_to']);
        $cacheKey = "marketing_offer_{$business->id}_".md5(json_encode($filters));
    ...
    public function getLeadSourceAnalysis(Request $request)
    {
        ...
        $filters = $request->only(['date_from', 'date_to']);
        $cacheKey = "marketing_lead_source_{$business->id}_".md5(json_encode($filters));
    ...
    public function getRevenueTrends(Request $request)
    {
        ...
        $cacheKey = "marketing_revenue_trends_{$business->id}_{$granularity}_{$days}";
    ...
    public function contentPerformance(Request $request)
    {
        ...
        $cacheKey = "marketing_content_performance_{$business->id}_{$period}";
        ...
        return Inertia::render('Marketing/Analytics/ContentPerformance', [
            'data' => $data,
            'period' => $period,
        ]);
    }

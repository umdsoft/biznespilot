...
class OffersController extends Controller
{
    ...
    public function create()
    {
        ...
        return Inertia::render('Marketing/Offers/Builder', [
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('marketing.offers.show', $offer)
                ->with('success', 'Taklif muvaffaqiyatli yaratildi!');

        } catch (\Exception $e) {
            DB::rollBack();
            return back()->withErrors(['error' => 'Taklif yaratishda xatolik: ' . $e->getMessage()]);
        }
    }
    ...
    public function show(Offer $offer)
    {
        ...
        return Inertia::render('Marketing/Offers/Show', [
            'offer' => [
                'id' => $offer->id,
                'name' => $offer->name,
                'description' => $offer->description,
    ...
    public function update(Request $request, Offer $offer)
    {
        ...
        return redirect()->route('marketing.offers.show', $offer)
            ->with('success', 'Taklif yangilandi!');
    }
    ...
    public function destroy(Offer $offer)
    {
        ...
        return redirect()->route('marketing.offers.index')
            ->with('success', 'Taklif o\'chirildi');
    }
    ...
    public function duplicate(Request $request, Offer $offer)
    {
        ...
        try {
            ...
            return redirect()->route('marketing.offers.edit', $newOffer)
                ->with('success', 'Taklif nusxalandi!');
